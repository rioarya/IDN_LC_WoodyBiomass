...
writer = pd.ExcelWriter('OutDSM_PF_SF_Ret.xlsx', engine = 'xlsxwriter')


df.to_excel(writer, sheet_name = 'PF_SF_Ret', header=True, index=False)
...
#S2
df2_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Ret.xlsx', 'PF_SF_S2')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Ret.xlsx', 'PF_SF_E')
...
#S2
df2_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Ret.xlsx', 'PF_SF_S2')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Ret.xlsx', 'PF_SF_E')
...
writer = pd.ExcelWriter('emissions_seq_PF_SF_Ret.xlsx', engine = 'xlsxwriter')
...
#wood-based 
#read S2_moist
df = pd.read_excel('emissions_seq_PF_SF_Ret.xlsx', 'S2_moist') # can also index sheet by name or fetch all sheets
...
#read S2_dry
df = pd.read_excel('emissions_seq_PF_SF_Ret.xlsx', 'S2_dry')
...
#read E_moist
df = pd.read_excel('emissions_seq_PF_SF_Ret.xlsx', 'E_moist') # can also index sheet by name or fetch all sheets
...
#read E_dry
df = pd.read_excel('emissions_seq_PF_SF_Ret.xlsx', 'E_dry')
...
#read S2
df = pd.read_excel('PF_SF_Ret.xlsx', 'NonRW_PF_SF_S2') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('PF_SF_Ret.xlsx', 'NonRW_PF_SF_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_SF_Ret.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_SF_Ret.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_SF_Ret.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_SF_Ret.xlsx', engine = 'xlsxwriter')
