...
df2_Ac7 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Ac_7y')
df2_Ac18 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Ac_18y')
df2_Tgr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Tgr_40y')
df2_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Tgr_60y')
dfE2_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_E2_Hbr_40y')
...
dfE2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_E2_Hbr_40y')
...
#S2_Ac_7y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Ac_7y')
...
decomp_tot_S2_Ac_7y = df['C_remainAGB'].values



#S2_Ac_18y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Ac_18y')
...
decomp_tot_S2_Ac_18y = df['C_remainAGB'].values
...
#S2_Tgr_40y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Tgr_40y')
...
decomp_tot_S2_Tgr_40y = df['C_remainAGB'].values
...
#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Tgr_60y')
...
decomp_tot_S2_Tgr_60y = df['C_remainAGB'].values




#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_E2_Hbr_40y')

tf = 201

t = np.arange(tf)

decomp_tot_E2_Hbr_40y = df['C_remainAGB'].values
...
TestDSM2_Ac7 = DynamicStockModel(t = df2_Ac7['Year'].values, i = df2_Ac7['Input_PF'].values, lt = {'Type': 'Normal', 'Mean': np.array([P]), 'StdDev': np.array([0.3*P])})
...
TestDSM2_Tgr40 = DynamicStockModel(t = df2_Tgr40['Year'].values, i = df2_Tgr40['Input_PF'].values, lt = {'Type': 'Normal', 'Mean': np.array([B]), 'StdDev': np.array([0.3*B])})
...
CheckStr2_Ac7, ExitFlag2_Ac7 = TestDSM2_Ac7.dimension_check()
CheckStr2_Ac18, ExitFlag2_Ac18 = TestDSM2_Ac18.dimension_check()
CheckStr2_Tgr40, ExitFlag2_Tgr40 = TestDSM2_Tgr40.dimension_check()
...
Stock_by_cohort2_Ac7, ExitFlag2_Ac7 = TestDSM2_Ac7.compute_s_c_inflow_driven()
Stock_by_cohort2_Ac18, ExitFlag2_Ac18 = TestDSM2_Ac18.compute_s_c_inflow_driven()
Stock_by_cohort2_Tgr40, ExitFlag2_Tgr40 = TestDSM2_Tgr40.compute_s_c_inflow_driven()
...
O2_Ac7, ExitFlag2_Ac7   = TestDSM2_Ac7.compute_outflow_total()
O2_Ac18, ExitFlag2_Ac18   = TestDSM2_Ac18.compute_outflow_total()
O2_Tgr40, ExitFlag2_Tgr40   = TestDSM2_Tgr40.compute_outflow_total()
...
DS2_Ac7, ExitFlag2_Ac7  = TestDSM2_Ac7.compute_stock_change()
DS2_Ac18, ExitFlag2_Ac18  = TestDSM2_Ac18.compute_stock_change()
DS2_Tgr40, ExitFlag2_Tgr40  = TestDSM2_Tgr40.compute_stock_change()
...
Bal2_Ac7, ExitFlag2_Ac7 = TestDSM2_Ac7.check_stock_balance()
Bal2_Ac18, ExitFlag2_Ac18 = TestDSM2_Ac18.check_stock_balance()
Bal2_Tgr40, ExitFlag2_Tgr40 = TestDSM2_Tgr40.check_stock_balance()
...
#print output flow
print(TestDSM2_Ac7.o)
print(TestDSM2_Ac18.o)
print(TestDSM2_Tgr40.o)
...
df2_Ac_7y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Ac_7y')
df2_Ac_18y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Ac_18y')
df2_Tgr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Tgr_40y')
df2_Tgr_60y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_S2_Tgr_60y')
dfE2_Hbr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP.xlsx', 'PF_FP_E2_Hbr_40y')



t = range(0,tf,1)

PH_Emissions_HWP2_Ac_7y = df2_Ac_7y['PH_Emissions_HWP'].values
PH_Emissions_HWP2_Ac_18y = df2_Ac_18y['PH_Emissions_HWP'].values
PH_Emissions_HWP2_Tgr_40y = df2_Tgr_40y['PH_Emissions_HWP'].values
...
#S2_Ac_7y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S2_Ac_7y')
...
def decomp_CH4_S2_Ac_7y(t,remainAGB_CH4_S2_Ac_7y):
    return (1-(1-np.exp(-k*t)))*remainAGB_CH4_S2_Ac_7y



#set zero matrix
output_decomp_CH4_S2_Ac_7y = np.zeros((len(t),len(df['Landfill_decomp_CH4'].values)))


for i,remain_part_CH4_S2_Ac_7y in enumerate(df['Landfill_decomp_CH4'].values):
    #print(i,remain_part)
    output_decomp_CH4_S2_Ac_7y[i:,i] = decomp_CH4_S2_Ac_7y(t[:len(t)-i],remain_part_CH4_S2_Ac_7y)

print(output_decomp_CH4_S2_Ac_7y[:,:4])
...
subs_matrix_CH4_S2_Ac_7y = np.zeros((len(t)-1,len(df['Landfill_decomp_CH4'].values-1)))

i = 0
while i < tf:
    subs_matrix_CH4_S2_Ac_7y[:,i] = np.diff(output_decomp_CH4_S2_Ac_7y[:,i])
    i = i + 1 

print(subs_matrix_CH4_S2_Ac_7y[:,:4])
print(len(subs_matrix_CH4_S2_Ac_7y))
...
subs_matrix_CH4_S2_Ac_7y = subs_matrix_CH4_S2_Ac_7y.clip(max=0)

print(subs_matrix_CH4_S2_Ac_7y[:,:4])

#make the results as absolute values
subs_matrix_CH4_S2_Ac_7y = abs(subs_matrix_CH4_S2_Ac_7y)
print(subs_matrix_CH4_S2_Ac_7y[:,:4])


#insert row of zeros into the first row of the subs_matrix
zero_matrix_CH4_S2_Ac_7y = np.zeros((len(t)-200,len(df['Landfill_decomp_CH4'].values)))
print(zero_matrix_CH4_S2_Ac_7y)

subs_matrix_CH4_S2_Ac_7y = np.vstack((zero_matrix_CH4_S2_Ac_7y, subs_matrix_CH4_S2_Ac_7y))

print(subs_matrix_CH4_S2_Ac_7y[:,:4])


#sum every column of the subs_matrix into one vector matrix
matrix_tot_CH4_S2_Ac_7y = (tf,1)
decomp_tot_CH4_S2_Ac_7y = np.zeros(matrix_tot_CH4_S2_Ac_7y) 

i = 0
while i < tf:
    decomp_tot_CH4_S2_Ac_7y[:,0] = decomp_tot_CH4_S2_Ac_7y[:,0] + subs_matrix_CH4_S2_Ac_7y[:,i]
    i = i + 1

print(decomp_tot_CH4_S2_Ac_7y[:,0])
 


#S2_Ac_18y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S2_Ac_18y')
...
#S2_Tgr_40y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S2_Tgr_40y')
...
def decomp_CH4_S2_Tgr_40y(t,remainAGB_CH4_S2_Tgr_40y):
    return (1-(1-np.exp(-k*t)))*remainAGB_CH4_S2_Tgr_40y



#set zero matrix
output_decomp_CH4_S2_Tgr_40y = np.zeros((len(t),len(df['Landfill_decomp_CH4'].values)))


for i,remain_part_CH4_S2_Tgr_40y in enumerate(df['Landfill_decomp_CH4'].values):
    #print(i,remain_part)
    output_decomp_CH4_S2_Tgr_40y[i:,i] = decomp_CH4_S2_Tgr_40y(t[:len(t)-i],remain_part_CH4_S2_Tgr_40y)

print(output_decomp_CH4_S2_Tgr_40y[:,:4])
...
#difference between element, 
subs_matrix_CH4_S2_Tgr_40y = np.zeros((len(t)-1,len(df['Landfill_decomp_CH4'].values-1)))

i = 0
while i < tf:
    subs_matrix_CH4_S2_Tgr_40y[:,i] = np.diff(output_decomp_CH4_S2_Tgr_40y[:,i])
    i = i + 1 

print(subs_matrix_CH4_S2_Tgr_40y[:,:4])
print(len(subs_matrix_CH4_S2_Tgr_40y))



#since there is no carbon emission from decomposition at the beginning of the year (esp. from 'year 1' onward), 
#we have to replace the positive numbers with 0 values (https://stackoverflow.com/questions/36310897/how-do-i-change-all-negative-numbers-to-zero-in-python/36310913)
subs_matrix_CH4_S2_Tgr_40y = subs_matrix_CH4_S2_Tgr_40y.clip(max=0)

print(subs_matrix_CH4_S2_Tgr_40y[:,:4])

#make the results as absolute values
subs_matrix_CH4_S2_Tgr_40y = abs(subs_matrix_CH4_S2_Tgr_40y)
print(subs_matrix_CH4_S2_Tgr_40y[:,:4])


#insert row of zeros into the first row of the subs_matrix
zero_matrix_CH4_S2_Tgr_40y = np.zeros((len(t)-200,len(df['Landfill_decomp_CH4'].values)))
print(zero_matrix_CH4_S2_Tgr_40y)

subs_matrix_CH4_S2_Tgr_40y = np.vstack((zero_matrix_CH4_S2_Tgr_40y, subs_matrix_CH4_S2_Tgr_40y))

print(subs_matrix_CH4_S2_Tgr_40y[:,:4])


#sum every column of the subs_matrix into one vector matrix
matrix_tot_CH4_S2_Tgr_40y = (tf,1)
decomp_tot_CH4_S2_Tgr_40y = np.zeros(matrix_tot_CH4_S2_Tgr_40y) 

i = 0
while i < tf:
    decomp_tot_CH4_S2_Tgr_40y[:,0] = decomp_tot_CH4_S2_Tgr_40y[:,0] + subs_matrix_CH4_S2_Tgr_40y[:,i]
    i = i + 1

print(decomp_tot_CH4_S2_Tgr_40y[:,0])



#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S2_Tgr_60y')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_E2_Hbr_40y')
...
plt.plot(t,decomp_tot_CH4_S2_Ac_7y,label='Ac_7y')
plt.plot(t,decomp_tot_CH4_S2_Ac_18y,label='Ac_18y')
plt.plot(t,decomp_tot_CH4_S2_Tgr_40y,label='Tgr_40y')
...
def decomp_S2_Ac_7y(t,remainAGB_S2_Ac_7y):
    return (1-(1-np.exp(-k*t)))*remainAGB_S2_Ac_7y



#set zero matrix
output_decomp_S2_Ac_7y = np.zeros((len(t),len(df['Landfill_decomp_CO2'].values)))


for i,remain_part_S2_Ac_7y in enumerate(df['Landfill_decomp_CO2'].values):
    #print(i,remain_part)
...
#difference between element, 
subs_matrix_S2_Ac_7y = np.zeros((len(t)-1,len(df['Landfill_decomp_CO2'].values-1)))
...
#insert row of zeros into the first row of the subs_matrix
zero_matrix_S2_Ac_7y = np.zeros((len(t)-200,len(df['Landfill_decomp_CO2'].values)))
...
decomp_tot_CO2_S2_Ac_7y = np.zeros(matrix_tot_S2_Ac_7y) 

i = 0
while i < tf:
    decomp_tot_CO2_S2_Ac_7y[:,0] = decomp_tot_CO2_S2_Ac_7y[:,0] + subs_matrix_S2_Ac_7y[:,i]
    i = i + 1

print(decomp_tot_CO2_S2_Ac_7y[:,0])
...
def decomp_S2_Tgr_40y(t,remainAGB_S2_Tgr_40y):
    return (1-(1-np.exp(-k*t)))*remainAGB_S2_Tgr_40y



#set zero matrix
output_decomp_S2_Tgr_40y = np.zeros((len(t),len(df['Landfill_decomp_CO2'].values)))


for i,remain_part_S2_Tgr_40y in enumerate(df['Landfill_decomp_CO2'].values):
    #print(i,remain_part)
...
#difference between element, 
subs_matrix_S2_Tgr_40y = np.zeros((len(t)-1,len(df['Landfill_decomp_CO2'].values-1)))
...
#insert row of zeros into the first row of the subs_matrix
zero_matrix_S2_Tgr_40y = np.zeros((len(t)-200,len(df['Landfill_decomp_CO2'].values)))
...
decomp_tot_CO2_S2_Tgr_40y = np.zeros(matrix_tot_S2_Tgr_40y) 

i = 0
while i < tf:
    decomp_tot_CO2_S2_Tgr_40y[:,0] = decomp_tot_CO2_S2_Tgr_40y[:,0] + subs_matrix_S2_Tgr_40y[:,i]
    i = i + 1

print(decomp_tot_CO2_S2_Tgr_40y[:,0])
...
plt.plot(t,decomp_tot_CO2_S2_Ac_7y,label='Ac_7y')
plt.plot(t,decomp_tot_CO2_S2_Ac_18y,label='Ac_18y')
plt.plot(t,decomp_tot_CO2_S2_Tgr_40y,label='Tgr_40y')
...
Emissions_S2_Ac_7y = [c_firewood_energy_S2_Ac7, decomp_tot_S2_Ac_7y, TestDSM2_Ac7.o, PH_Emissions_HWP2_Ac_7y, decomp_tot_CO2_S2_Ac_7y[:,0]]
Emissions_S2_Ac_18y = [c_firewood_energy_S2_Ac18, decomp_tot_S2_Ac_18y, TestDSM2_Ac18.o, PH_Emissions_HWP2_Ac_18y, decomp_tot_CO2_S2_Ac_18y[:,0]]
Emissions_S2_Tgr_40y = [c_firewood_energy_S2_Tgr40, decomp_tot_S2_Tgr_40y, TestDSM2_Tgr40.o, PH_Emissions_HWP2_Tgr_40y, decomp_tot_CO2_S2_Tgr_40y[:,0]]
Emissions_S2_Tgr_60y = [c_firewood_energy_S2_Tgr60, decomp_tot_S2_Tgr_60y, TestDSM2_Tgr60.o, PH_Emissions_HWP2_Tgr_60y, decomp_tot_CO2_S2_Tgr_60y[:,0]]
Emissions_E2_Hbr_40y = [c_firewood_energy_E2_Hbr40, c_pellets_Hbr_40y, decomp_tot_E2_Hbr_40y, TestDSME2_Hbr40.o, PH_Emissions_HWPE2_Hbr_40y, decomp_tot_CO2_E2_Hbr_40y[:,0]]


Emissions_PF_FP_S2_Ac_7y = [sum(x) for x in zip(*Emissions_S2_Ac_7y)]
Emissions_PF_FP_S2_Ac_18y = [sum(x) for x in zip(*Emissions_S2_Ac_18y)]
Emissions_PF_FP_S2_Tgr_40y = [sum(x) for x in zip(*Emissions_S2_Tgr_40y)]
Emissions_PF_FP_S2_Tgr_60y = [sum(x) for x in zip(*Emissions_S2_Tgr_60y)]
Emissions_PF_FP_E2_Hbr_40y = [sum(x) for x in zip(*Emissions_E2_Hbr_40y)]


#CH4_S2_Ac_7y
Emissions_CH4_PF_FP_S2_Ac_7y = decomp_tot_CH4_S2_Ac_7y[:,0]


#CH4_S2_Ac_18y
Emissions_CH4_PF_FP_S2_Ac_18y = decomp_tot_CH4_S2_Ac_18y[:,0]

#CH4_S2_Tgr_40y
Emissions_CH4_PF_FP_S2_Tgr_40y = decomp_tot_CH4_S2_Tgr_40y[:,0]

#CH4_S2_Tgr_60y
Emissions_CH4_PF_FP_S2_Tgr_60y = decomp_tot_CH4_S2_Tgr_60y[:,0]

#CH4_E2_Hbr_40y
Emissions_CH4_PF_FP_E2_Hbr_40y = decomp_tot_CH4_E2_Hbr_40y[:,0]
...
Col1 = year
Col2_S2_Ac_7y = Emissions_PF_FP_S2_Ac_7y
Col2_S2_Ac_18y = Emissions_PF_FP_S2_Ac_18y
Col2_S2_Tgr_40y = Emissions_PF_FP_S2_Tgr_40y
Col2_S2_Tgr_60y = Emissions_PF_FP_S2_Tgr_60y
Col2_E2_Hbr_40y = Emissions_PF_FP_E2_Hbr_40y

Col3_S2_Ac_7y = Emissions_CH4_PF_FP_S2_Ac_7y
Col3_S2_Ac_18y = Emissions_CH4_PF_FP_S2_Ac_18y
Col3_S2_Tgr_40y = Emissions_CH4_PF_FP_S2_Tgr_40y
Col3_S2_Tgr_60y = Emissions_CH4_PF_FP_S2_Tgr_60y
Col3_E2_Hbr_40y = Emissions_CH4_PF_FP_E2_Hbr_40y
...
#A. crassicarpa
df2_Ac_7y = pd.DataFrame.from_dict({'Year':Col1,'kg_CO2':Col2_S2_Ac_7y,'kg_CH4':Col3_S2_Ac_7y,'kg_CO2_seq':Col5,'emission_ref':Col4})
...
#T. grandis
df2_Tgr_40y = pd.DataFrame.from_dict({'Year':Col1,'kg_CO2':Col2_S2_Tgr_40y,'kg_CH4':Col3_S2_Tgr_40y,'kg_CO2_seq':Col7,'emission_ref':Col4})
...
writer = pd.ExcelWriter('emissions_seq_PF_FP_Rel.xlsx', engine = 'xlsxwriter')

df2_Ac_7y.to_excel(writer, sheet_name = 'PF_FP_S2_Ac_7y', header=True, index=False )
df2_Ac_18y.to_excel(writer, sheet_name = 'PF_FP_S2_Ac_18y', header=True, index=False)
df2_Tgr_40y.to_excel(writer, sheet_name = 'PF_FP_S2_Tgr_40y', header=True, index=False)
df2_Tgr_60y.to_excel(writer, sheet_name = 'PF_FP_S2_Tgr_60y', header=True, index=False)
dfE2_Hbr_40y.to_excel(writer, sheet_name = 'PF_FP_E2_Hbr_40y', header=True, index=False)
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_PF_FP_Rel.xlsx', 'PF_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
emission_CO2_S2_Ac_7y = df['kg_CO2'].tolist()
emission_CH4_S2_Ac_7y = df['kg_CH4'].tolist()
emission_CO2_seq_S2_Ac_7y = df['kg_CO2_seq'].tolist()

emission_CO2_ref = df['emission_ref'].tolist() 

#read S2_Ac_18y
df = pd.read_excel('emissions_seq_PF_FP_Rel.xlsx', 'PF_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_PF_FP_Rel.xlsx', 'PF_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
emission_CO2_S2_Tgr_40y = df['kg_CO2'].tolist()
emission_CH4_S2_Tgr_40y = df['kg_CH4'].tolist()
emission_CO2_seq_S2_Tgr_40y = df['kg_CO2_seq'].tolist()



#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_PF_FP_Rel.xlsx', 'PF_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_PF_FP_Rel.xlsx', 'PF_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_7y
df = pd.read_excel('NonRW_PF_FP.xlsx', 'PF_FP_S2_Ac_7y')
emissions_NonRW_S2_Ac_7y = df['NonRW_emissions'].tolist()
emissions_NonRW_S2_Ac_7y_seq = df['kg_CO2_seq'].tolist()

emission_CO2_ref = df['emission_ref'].tolist() 


#read S2_Ac_18y
df = pd.read_excel('NonRW_PF_FP.xlsx', 'PF_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('NonRW_PF_FP.xlsx', 'PF_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
emissions_NonRW_S2_Tgr_40y = df['NonRW_emissions'].tolist()
emissions_NonRW_S2_Tgr_40y_seq = df['kg_CO2_seq'].tolist()


#read S2_Tgr_60y
df = pd.read_excel('NonRW_PF_FP.xlsx', 'PF_FP_S2_Tgr_60y')
emissions_NonRW_S2_Tgr_60y = df['NonRW_emissions'].tolist()
emissions_NonRW_S2_Tgr_60y_seq = df['kg_CO2_seq'].tolist()


#read E2_Hbr_40y
df = pd.read_excel('NonRW_PF_FP.xlsx', 'PF_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
matrix_GWI_S2_Ac_7y = (tf-1,3)
GWI_inst_S2_Ac_7y = np.zeros(matrix_GWI_S2_Ac_7y)



for t in range(0,tf-1):
    GWI_inst_S2_Ac_7y[t,0] = np.sum(np.multiply(emission_CO2_S2_Ac_7y,DCF_CO2_ti[:,t]))
    GWI_inst_S2_Ac_7y[t,1] = np.sum(np.multiply(emission_CH4_S2_Ac_7y,DCF_CH4_ti[:,t]))
    GWI_inst_S2_Ac_7y[t,2] = np.sum(np.multiply(emission_CO2_seq_S2_Ac_7y,DCF_CO2_ti[:,t]))


    
matrix_GWI_tot_S2_Ac_7y = (tf-1,1)
GWI_inst_tot_S2_Ac_7y = np.zeros(matrix_GWI_tot_S2_Ac_7y)

GWI_inst_tot_S2_Ac_7y[:,0] = np.array(GWI_inst_S2_Ac_7y[:,0] + GWI_inst_S2_Ac_7y[:,1] + GWI_inst_S2_Ac_7y[:,2])
  
print(GWI_inst_tot_S2_Ac_7y[:,0])
...
matrix_GWI_S2_Tgr_40y = (tf-1,3)
GWI_inst_S2_Tgr_40y = np.zeros(matrix_GWI_S2_Tgr_40y)



for t in range(0,tf-1):
    GWI_inst_S2_Tgr_40y[t,0] = np.sum(np.multiply(emission_CO2_S2_Tgr_40y,DCF_CO2_ti[:,t]))
    GWI_inst_S2_Tgr_40y[t,1] = np.sum(np.multiply(emission_CH4_S2_Tgr_40y,DCF_CH4_ti[:,t]))
    GWI_inst_S2_Tgr_40y[t,2] = np.sum(np.multiply(emission_CO2_seq_S2_Tgr_40y,DCF_CO2_ti[:,t]))

matrix_GWI_tot_S2_Tgr_40y = (tf-1,1)
GWI_inst_tot_S2_Tgr_40y = np.zeros(matrix_GWI_tot_S2_Tgr_40y)

GWI_inst_tot_S2_Tgr_40y[:,0] = np.array(GWI_inst_S2_Tgr_40y[:,0] + GWI_inst_S2_Tgr_40y[:,1] + GWI_inst_S2_Tgr_40y[:,2])
  
print(GWI_inst_tot_S2_Tgr_40y[:,0])
...
matrix_GWI_NonRW_S2_Ac_7y = (tf-1,2)
GWI_inst_NonRW_S2_Ac_7y = np.zeros(matrix_GWI_NonRW_S2_Ac_7y)



for t in range(0,tf-1):
    GWI_inst_NonRW_S2_Ac_7y[t,0] = np.sum(np.multiply(emissions_NonRW_S2_Ac_7y,DCF_CO2_ti[:,t]))
    GWI_inst_NonRW_S2_Ac_7y[t,1] = np.sum(np.multiply(emissions_NonRW_S2_Ac_7y_seq,DCF_CO2_ti[:,t]))


matrix_GWI_tot_NonRW_S2_Ac_7y = (tf-1,1)
GWI_inst_tot_NonRW_S2_Ac_7y = np.zeros(matrix_GWI_tot_NonRW_S2_Ac_7y)

GWI_inst_tot_NonRW_S2_Ac_7y[:,0] = np.array(GWI_inst_NonRW_S2_Ac_7y[:,0] + GWI_inst_NonRW_S2_Ac_7y[:,1])
print(GWI_inst_tot_NonRW_S2_Ac_7y[:,0])
...
matrix_GWI_NonRW_S2_Tgr_40y = (tf-1,2)
GWI_inst_NonRW_S2_Tgr_40y = np.zeros(matrix_GWI_NonRW_S2_Tgr_40y)



for t in range(0,tf-1):
    GWI_inst_NonRW_S2_Tgr_40y[t,0] = np.sum(np.multiply(emissions_NonRW_S2_Tgr_40y,DCF_CO2_ti[:,t]))
    GWI_inst_NonRW_S2_Tgr_40y[t,1] = np.sum(np.multiply(emissions_NonRW_S2_Tgr_40y_seq,DCF_CO2_ti[:,t]))


matrix_GWI_tot_NonRW_S2_Tgr_40y = (tf-1,1)
GWI_inst_tot_NonRW_S2_Tgr_40y = np.zeros(matrix_GWI_tot_NonRW_S2_Tgr_40y)

GWI_inst_tot_NonRW_S2_Tgr_40y[:,0] = np.array(GWI_inst_NonRW_S2_Tgr_40y[:,0] + GWI_inst_NonRW_S2_Tgr_40y[:,1])
print(GWI_inst_tot_NonRW_S2_Tgr_40y[:,0])
...
GWI_inst_tot_NonRW_S2_Ac_7y = np.array([item for sublist in GWI_inst_tot_NonRW_S2_Ac_7y for item in sublist])
...
GWI_inst_tot_S2_Ac_7y = np.array([item for sublist in GWI_inst_tot_S2_Ac_7y for item in sublist])
...
plt.plot(t, GWI_inst_tot_NonRW_S2_Ac_7y, color='olive', label='NR_M_Ac_7y', ls='--', alpha=0.55)
plt.plot(t, GWI_inst_tot_NonRW_S2_Ac_18y, color='forestgreen', label='NR_M_Ac_18y', ls='--', alpha=0.55)
#plt.plot(t, GWI_inst_tot_NonRW_S2_Tgr_40y, color='lightcoral', label='NR_M_Tgr_40y', ls='--', alpha=0.55)
plt.plot(t, GWI_inst_tot_NonRW_S2_Tgr_60y, color='deeppink', label='NR_M_Tgr_60y', ls='--', alpha=0.55)
plt.plot(t, GWI_inst_tot_NonRW_E2_Hbr_40y, color='royalblue', label='NR_E_Hbr_40y', ls='--', alpha=0.55)


plt.plot(t, GWI_inst_tot_S2_Ac_7y, color='olive', label='M_Ac_7y')
plt.plot(t, GWI_inst_tot_S2_Ac_18y, color='forestgreen', label='M_Ac_18y')
#plt.plot(t, GWI_inst_tot_S2_Tgr_40y, color='lightcoral', label='S2_Tgr_40y')
plt.plot(t, GWI_inst_tot_S2_Tgr_60y, color='deeppink', label='M_Tgr_60y')
plt.plot(t, GWI_inst_tot_E2_Hbr_40y, color='royalblue', label='E_Hbr_40y')
...
#plt.fill_between(t, GWI_inst_tot_NonRW_S2_Ac_7y, GWI_inst_tot_NonRW_S2_Tgr_40y, color='lightcoral', alpha=0.3)
...
plt.xlim(0,200)
#plt.ylim(-2.2e-9,1.7e-9)
plt.ylim(-1e-9,2.2e-9)


plt.title('Instantaneous GWI, PF_FP')
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWI_inst_NonRW_PF_FP_S2', dpi=300)
...
##Wood-based
GWI_cum_S2_Ac_7y = np.cumsum(GWI_inst_tot_S2_Ac_7y)
GWI_cum_S2_Ac_18y = np.cumsum(GWI_inst_tot_S2_Ac_18y)
GWI_cum_S2_Tgr_40y = np.cumsum(GWI_inst_tot_S2_Tgr_40y)
GWI_cum_S2_Tgr_60y = np.cumsum(GWI_inst_tot_S2_Tgr_60y)
GWI_cum_E2_Hbr_40y = np.cumsum(GWI_inst_tot_E2_Hbr_40y)


##NonRW
GWI_cum_NonRW_S2_Ac_7y = np.cumsum(GWI_inst_tot_NonRW_S2_Ac_7y)
GWI_cum_NonRW_S2_Ac_18y = np.cumsum(GWI_inst_tot_NonRW_S2_Ac_18y)
GWI_cum_NonRW_S2_Tgr_40y = np.cumsum(GWI_inst_tot_NonRW_S2_Tgr_40y)
...
plt.xlim(0,200)
#plt.ylim(-2.3e-7,2.1e-7)
#plt.ylim(-1e-7,2.3e-7)


plt.title('Cumulative GWI, PF_FP')

plt.plot(t, GWI_cum_NonRW_S2_Ac_7y, color='olive', label='NR_M_Ac_7y', ls='--', alpha=0.55)
plt.plot(t, GWI_cum_NonRW_S2_Ac_18y, color='forestgreen', label='NR_M_Ac_18y', ls='--', alpha=0.55)
#plt.plot(t, GWI_cum_NonRW_S2_Tgr_40y, color='lightcoral', label='NR_M_Tgr_40y', ls='--', alpha=0.55)
plt.plot(t, GWI_cum_NonRW_S2_Tgr_60y, color='deeppink', label='NR_M_Tgr_60y', ls='--', alpha=0.55)
plt.plot(t, GWI_cum_NonRW_E2_Hbr_40y, color='royalblue', label='NR_E_Hbr_40y', ls='--', alpha=0.55)

plt.plot(t, GWI_cum_S2_Ac_7y, color='olive', label='M_Ac_7y')
plt.plot(t, GWI_cum_S2_Ac_18y, color='forestgreen', label='M_Ac_18y')
#plt.plot(t, GWI_cum_S2_Tgr_40y, color='lightcoral', label='S2_Tgr_40y')
plt.plot(t, GWI_cum_S2_Tgr_60y, color='deeppink', label='M_Tgr_60y')
plt.plot(t, GWI_cum_E2_Hbr_40y, color='royalblue', label='E_Hbr_40y')
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWI_cum_PF_FP_S2', dpi=300)
...
GWI_inst_ref = np.zeros(matrix_GWI_S2_Ac_7y)
...
##wood-based
GWP_dyn_cum_S2_Ac_7y = [x/(y*1000) for x,y in zip(GWI_cum_S2_Ac_7y, GWI_cum_ref)]
GWP_dyn_cum_S2_Ac_18y = [x/(y*1000) for x,y in zip(GWI_cum_S2_Ac_18y, GWI_cum_ref)]
GWP_dyn_cum_S2_Tgr_40y = [x/(y*1000) for x,y in zip(GWI_cum_S2_Tgr_40y, GWI_cum_ref)]
...
##NonRW
GWP_dyn_cum_NonRW_S2_Ac_7y = [x/(y*1000) for x,y in zip(GWI_cum_NonRW_S2_Ac_7y, GWI_cum_ref)]
GWP_dyn_cum_NonRW_S2_Ac_18y = [x/(y*1000) for x,y in zip(GWI_cum_NonRW_S2_Ac_18y, GWI_cum_ref)]
GWP_dyn_cum_NonRW_S2_Tgr_40y = [x/(y*1000) for x,y in zip(GWI_cum_NonRW_S2_Tgr_40y, GWI_cum_ref)]
...
ax.plot(t, GWP_dyn_cum_NonRW_S2_Ac_7y, color='olive', label='NR_M_Ac_7y', ls='--', alpha=0.55)
ax.plot(t, GWP_dyn_cum_NonRW_S2_Ac_18y, color='forestgreen', label='NR_M_Ac_18y', ls='--', alpha=0.55)
#ax.plot(t, GWP_dyn_cum_NonRW_S2_Tgr_40y, color='lightcoral', label='NR_S2_Tgr_40y', ls='--', alpha=0.55)
ax.plot(t, GWP_dyn_cum_NonRW_S2_Tgr_60y, color='deeppink', label='NR_M_Tgr_60y', ls='--', alpha=0.55)
ax.plot(t, GWP_dyn_cum_NonRW_E2_Hbr_40y, color='royalblue', label='NR_E_Hbr_40y', ls='--', alpha=0.55)


ax.plot(t, GWP_dyn_cum_S2_Ac_7y, color='olive', label='M_Ac_7y')
ax.plot(t, GWP_dyn_cum_S2_Ac_18y, color='forestgreen', label='M_Ac_18y')
#ax.plot(t, GWP_dyn_cum_S2_Tgr_40y, color='lightcoral', label='S2_Tgr_40y')
ax.plot(t, GWP_dyn_cum_S2_Tgr_60y, color='deeppink', label='M_Tgr_60y')
ax.plot(t, GWP_dyn_cum_E2_Hbr_40y, color='royalblue', label='E_Hbr_40y')

ax.plot(t, zerolistmaker(tf-1), color='black', label='Zero line', ls='--', alpha=0.75)

#plt.fill_between(t, GWP_dyn_cum_NonRW_E2_Hbr_40y, GWP_dyn_cum_NonRW_S2_Tgr_60y, color='lightcoral', alpha=0.3) 
...
ax.set_title('Dynamic GWP, PF_FP')


plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWP_dyn_cum_NonRW_PF_FP_S2', dpi=300)
...
Col_GI_1 = GWI_inst_tot_S2_Ac_7y 
...
Col_GI_5  = GWI_inst_tot_NonRW_S2_Ac_7y
...
Col_GC_5 = GWI_cum_NonRW_S2_Ac_7y
...
Col_GWP_1 = GWP_dyn_cum_S2_Ac_7y
...
Col_GWP_5 = GWP_dyn_cum_NonRW_S2_Ac_7y
...
dfM_GI = pd.DataFrame.from_dict({'Year':Col1,'M_Ac_7y (W/m2)':Col_GI_1, 'M_Ac_18y (W/m2)':Col_GI_2,
                                       'M_Tgr_60y (W/m2)':Col_GI_3, 'E_Hbr_40y (W/m2)':Col_GI_4,
                                       'NR_M_Ac_7y (W/m2)':Col_GI_5, 'NR_M_Ac_18y (W/m2)':Col_GI_6,
                                       'NR_M_Tgr_60y (W/m2)':Col_GI_7, 'NR_E_Hbr_40y (W/m2)':Col_GI_8})


dfM_GC = pd.DataFrame.from_dict({'Year':Col1,'M_Ac_7y (W/m2)':Col_GC_1, 'M_Ac_18y (W/m2)':Col_GC_2,
                                       'M_Tgr_60y (W/m2)':Col_GC_3, 'E_Hbr_40y (W/m2)':Col_GC_4,
                                       'NR_M_Ac_7y (W/m2)':Col_GC_5, 'NR_M_Ac_18y (W/m2)':Col_GC_6,
                                       'NR_M_Tgr_60y (W/m2)':Col_GC_7, 'NR_E_Hbr_40y (W/m2)':Col_GC_8})

    

dfM_GWP = pd.DataFrame.from_dict({'Year':Col1,'M_Ac_7y (t-CO2-eq)':Col_GWP_1, 'M_Ac_18y (t-CO2-eq)':Col_GWP_2,
                                        'M_Tgr_60y (t-CO2-eq)':Col_GWP_3, 'E_Hbr_40y (t-CO2-eq)':Col_GWP_4,
                                        'NR_M_Ac_7y (t-CO2-eq)':Col_GWP_5, 'NR_M_Ac_18y (t-CO2-eq)':Col_GWP_6,
                                        'NR_M_Tgr_60y (t-CO2-eq)':Col_GWP_7, 'NR_E_Hbr_40y (t-CO2-eq)':Col_GWP_8})



#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_FP_Rel.xlsx', engine = 'xlsxwriter')


dfM_GI.to_excel(writer, sheet_name = 'GWI_Inst_PF_FP', header=True, index=False )


dfM_GC.to_excel(writer, sheet_name = 'Cumulative GWI_PF_FP', header=True, index=False)


dfM_GWP.to_excel(writer, sheet_name = 'GWPdyn_PF_FP', header=True, index=False )
...
#M_Ac_7y
c_firewood_energy_S2_Ac7 = [x/division for x in c_firewood_energy_S2_Ac7]
decomp_tot_S2_Ac_7y = [x/division for x in decomp_tot_S2_Ac_7y]
TestDSM2_Ac7.o = [x/division for x in TestDSM2_Ac7.o]
PH_Emissions_HWP2_Ac_7y = [x/division for x in PH_Emissions_HWP2_Ac_7y]
#OC_storage_S2_Ac7 = [x/division for x in OC_storage_S2_Ac7]
flat_list_Ac_7y = [x/division for x in flat_list_Ac_7y]
decomp_tot_CO2_S2_Ac_7y[:,0] = [x/division for x in decomp_tot_CO2_S2_Ac_7y[:,0]]

decomp_tot_CH4_S2_Ac_7y[:,0] = [x/division_CH4 for x in decomp_tot_CH4_S2_Ac_7y[:,0]]


#M_Ac_18y
c_firewood_energy_S2_Ac18 = [x/division for x in c_firewood_energy_S2_Ac18]
decomp_tot_S2_Ac_18y = [x/division for x in decomp_tot_S2_Ac_18y]
...
decomp_tot_S2_Tgr_60y = [x/division for x in decomp_tot_S2_Tgr_60y]
...
decomp_tot_E2_Hbr_40y = [x/division for x in decomp_tot_E2_Hbr_40y]
...
Landfill_decomp_PF_FP_S2_Ac_7y = decomp_tot_CH4_S2_Ac_7y, decomp_tot_CO2_S2_Ac_7y
Landfill_decomp_PF_FP_S2_Ac_18y = decomp_tot_CH4_S2_Ac_18y, decomp_tot_CO2_S2_Ac_18y
Landfill_decomp_PF_FP_S2_Tgr_60y = decomp_tot_CH4_S2_Tgr_60y, decomp_tot_CO2_S2_Tgr_60y
Landfill_decomp_PF_FP_E2_Hbr_40y = decomp_tot_CH4_E2_Hbr_40y, decomp_tot_CO2_E2_Hbr_40y


Landfill_decomp_PF_FP_S2_Ac_7y = [sum(x) for x in zip(*Landfill_decomp_PF_FP_S2_Ac_7y)]
Landfill_decomp_PF_FP_S2_Ac_18y = [sum(x) for x in zip(*Landfill_decomp_PF_FP_S2_Ac_18y)]
Landfill_decomp_PF_FP_S2_Tgr_60y = [sum(x) for x in zip(*Landfill_decomp_PF_FP_S2_Tgr_60y)]
Landfill_decomp_PF_FP_E2_Hbr_40y = [sum(x) for x in zip(*Landfill_decomp_PF_FP_E2_Hbr_40y)]

Landfill_decomp_PF_FP_S2_Ac_7y = [item for sublist in Landfill_decomp_PF_FP_S2_Ac_7y for item in sublist]
Landfill_decomp_PF_FP_S2_Ac_18y = [item for sublist in Landfill_decomp_PF_FP_S2_Ac_18y for item in sublist]
Landfill_decomp_PF_FP_S2_Tgr_60y = [item for sublist in Landfill_decomp_PF_FP_S2_Tgr_60y for item in sublist]
Landfill_decomp_PF_FP_E2_Hbr_40y = [item for sublist in Landfill_decomp_PF_FP_E2_Hbr_40y for item in sublist]
...
dfM_Ac_7y = pd.DataFrame.from_dict({'Year':Column1, 'F0-1: Biomass C sequestration (t-C)':Column7,
                                    #'F3-5: Landfill storage (t-C)':Column6_1,
...
dfM_Ac_18y = pd.DataFrame.from_dict({'Year':Column1,'F0-1: Biomass C sequestration  (t-C)':Column13,
                                     #'F3-5: Landfill storage (t-C)':Column12_1,
...
dfE_Tgr_60y = pd.DataFrame.from_dict({'Year':Column1,'F0-1: Biomass C sequestration  (t-C)':Column19,
                                      #'F3-5: Landfill storage (t-C)':Column18_1,
...
dfE_Hbr_40y = pd.DataFrame.from_dict({'Year':Column1,'F0-1: Biomass C sequestration  (t-C)':Column25,
                                      #'F3-5: Landfill storage (t-C)':Column24_1,
...
writer = pd.ExcelWriter('C_flows_PF_FP_Rel.xlsx', engine = 'xlsxwriter')



dfM_Ac_7y.to_excel(writer, sheet_name = 'PF_FP_M_Ac_7y', header=True, index=False)
dfM_Ac_18y.to_excel(writer, sheet_name = 'PF_FP_M_Ac_18y', header=True, index=False)
dfE_Tgr_60y.to_excel(writer, sheet_name = 'PF_FP_M_Tgr_60y', header=True, index=False)
dfE_Hbr_40y.to_excel(writer, sheet_name = 'PF_FP_E2_Hbr_40y', header=True, index=False)
...
#ax1.plot(t, OC_storage_S2_Ac7, color='darkturquoise', label='F3-5: Landfill storage') 
ax1.plot(t, decomp_tot_S2_Ac_7y, color='lightcoral', label='F1-0: Residue decomposition')
ax1.plot(t, c_firewood_energy_S2_Ac7, color='mediumseagreen', label='F6-0-1: Emissions from firewood/other energy use') 
ax1.plot(t, PH_Emissions_HWP2_Ac_7y, color='orange', label='F8-0: Operational stage/processing emissions')
ax1.plot(t, TestDSM2_Ac7.o, color='royalblue', label='F6-0-2: Energy use emissions from in-use stocks outflow')
ax1.plot(t, Landfill_decomp_PF_FP_S2_Ac_7y, color='yellow', label='F7-0: Landfill gas decomposition')
...
ax1.set_title('Carbon flow, PF_FP_M_Ac_7y (symlog-scale)')
...
#ax_a.plot(t, OC_storage_S2_Ac7, color='darkturquoise', label='F3-5: Landfill storage') 
ax_a.plot(t, decomp_tot_S2_Ac_7y, color='lightcoral', label='F1-0: Residue decomposition')
ax_a.plot(t, c_firewood_energy_S2_Ac7, color='mediumseagreen', label='F6-0-1: Emissions from firewood/other energy use') 
ax_a.plot(t, PH_Emissions_HWP2_Ac_7y, color='orange', label='F8-0: Operational stage/processing emissions')
ax_a.plot(t, TestDSM2_Ac7.o, color='royalblue', label='F6-0-2: Energy use emissions from in-use stocks outflow ')
ax_a.plot(t, Landfill_decomp_PF_FP_S2_Ac_7y, color='yellow', label='F7-0: Landfill gas decomposition')


ax_b.plot(t, c_firewood_energy_S2_Ac7, color='mediumseagreen')
ax_b.plot(t, decomp_tot_S2_Ac_7y, color='lightcoral')
ax_b.plot(t, TestDSM2_Ac7.o, color='royalblue')
ax_b.plot(t, PH_Emissions_HWP2_Ac_7y, color='orange')
#ax_b.plot(t, OC_storage_S2_Ac7, color='darkturquoise') 
ax_b.plot(t, Landfill_decomp_PF_FP_S2_Ac_7y, color='yellow')
...
ax_a.set_title('Carbon flow, PF_FP_M_Ac_7y')
...
#ax2.plot(t, OC_storage_S2_Ac18, color='darkturquoise', label='F3-5: Landfill storage')
ax2.plot(t, decomp_tot_S2_Ac_18y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax2.plot(t, Landfill_decomp_PF_FP_S2_Ac_18y, color='yellow', label='F7-0: Landfill gas decomposition') 
...
ax2.set_title('Carbon flow, PF_FP_M_Ac_18y (symlog-scale)')
...
#ax_c.plot(t, OC_storage_S2_Ac18, color='darkturquoise', label='F3-5: Landfill storage')
ax_c.plot(t, decomp_tot_S2_Ac_18y, color='lightcoral', label='F1-0: Residue decomposition')
ax_c.plot(t, c_firewood_energy_S2_Ac18, color='mediumseagreen', label='F6-0-1: Emissions from firewood/other energy use')
ax_c.plot(t, PH_Emissions_HWP2_Ac_18y, color='orange', label='F8-0: Operational stage/processing emissions') 
ax_c.plot(t, TestDSM2_Ac18.o, color='royalblue', label='F6-0-2: Energy use emissions from in-use stocks outflow')
ax_c.plot(t, Landfill_decomp_PF_FP_S2_Ac_18y, color='yellow', label='F7-0: Landfill gas decomposition') 



ax_d.plot(t, c_firewood_energy_S2_Ac18, color='mediumseagreen')
ax_d.plot(t, decomp_tot_S2_Ac_18y, color='lightcoral')
ax_d.plot(t, TestDSM2_Ac18.o, color='royalblue')
ax_d.plot(t, PH_Emissions_HWP2_Ac_18y, color='orange')
#ax_d.plot(t, OC_storage_S2_Ac18, color='darkturquoise')
ax_d.plot(t, Landfill_decomp_PF_FP_S2_Ac_18y, color='yellow')
...
ax_c.set_title('Carbon flow, PF_FP_M_Ac_18y')
#plt.plot(t, Cflow_PF_SF_S1)
#plt.plot(t, Cflow_PF_SF_S2)
#plt.plot(t, Cflow_PF_SF_E)
#plt.xlim([0, 200])
...
#ax3.plot(t, OC_storage_S2_Tgr60, color='darkturquoise', label='F3-5: Landfill storage')
ax3.plot(t, decomp_tot_S2_Tgr_60y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax3.plot(t, Landfill_decomp_PF_FP_S2_Tgr_60y, color='yellow', label='F7-0: Landfill gas decomposition') 
...
ax3.set_title('Carbon flow, PF_FP_M_Tgr_60y (symlog-scale)')
...
#ax_e.plot(t, OC_storage_S2_Tgr60, color='darkturquoise', label='F3-5: Landfill storage')
ax_e.plot(t, decomp_tot_S2_Tgr_60y, color='lightcoral', label='F1-0: Residue decomposition')
ax_e.plot(t, c_firewood_energy_S2_Tgr60, color='mediumseagreen', label='F6-0-1: Emissions from firewood/other energy use')
ax_e.plot(t, PH_Emissions_HWP2_Tgr_60y, color='orange', label='F8-0: Operational stage/processing emissions') 
ax_e.plot(t, TestDSM2_Tgr60.o, color='royalblue', label='F6-0-2: Energy use emissions from in-use stocks outflow ') 
ax_e.plot(t, Landfill_decomp_PF_FP_S2_Tgr_60y, color='yellow', label='F7-0: Landfill gas decomposition') 

 
ax_f.plot(t, c_firewood_energy_S2_Tgr60, color='mediumseagreen')
ax_f.plot(t, decomp_tot_S2_Tgr_60y,color='lightcoral')
ax_f.plot(t, TestDSM2_Tgr60.o, color='royalblue')
ax_f.plot(t, PH_Emissions_HWP2_Tgr_60y, color='orange')
#ax_f.plot(t, OC_storage_S2_Tgr60, color='darkturquoise')
ax_f.plot(t, Landfill_decomp_PF_FP_S2_Tgr_60y, color='yellow')
...
ax_e.set_title('Carbon flow, PF_FP_M_Tgr_60y')
#plt.plot(t, Cflow_PF_SF_S1)
#plt.plot(t, Cflow_PF_SF_S2)
#plt.plot(t, Cflow_PF_SF_E)
#plt.xlim([0, 200])
...
#ax4.plot(t, OC_storage_E2_Hbr40, color='darkturquoise', label='F3-5: Landfill storage')
ax4.plot(t, decomp_tot_E2_Hbr_40y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax4.plot(t, Landfill_decomp_PF_FP_E2_Hbr_40y, color='yellow', label='F7-0: Landfill gas decomposition') 
ax4.plot(t, c_pellets_Hbr_40y, color='slategrey', label='F4-0: Emissions from wood pellets use') 

#ax_g.plot(t, TestDSME2_Hbr40.o, label='in-use stock output')
...
ax4.set_title('Carbon flow, PF_FP_E_Hbr_40y (symlog-scale)')
...
#ax_g.plot(t, OC_storage_E2_Hbr40, color='darkturquoise', label='F3-5: Landfill storage')
ax_g.plot(t, decomp_tot_E2_Hbr_40y, color='lightcoral', label='F1-0: Residue decomposition')
ax_g.plot(t, c_firewood_energy_E2_Hbr40, color='mediumseagreen', label='F6-0-1: Emissions from firewood/other energy use') 
ax_g.plot(t, PH_Emissions_HWPE2_Hbr_40y, color='orange', label='F8-0: Operational stage/processing emissions') 
ax_g.plot(t, Landfill_decomp_PF_FP_E2_Hbr_40y, color='yellow', label='F7-0: Landfill gas decomposition') 
...
ax_h.plot(t, c_firewood_energy_E2_Hbr40, color='mediumseagreen')
ax_h.plot(t, c_pellets_Hbr_40y, color='slategrey') 
ax_h.plot(t, decomp_tot_E2_Hbr_40y, color='lightcoral')
#ax_h.plot(t, TestDSME2_Hbr40.o)
ax_h.plot(t, PH_Emissions_HWPE2_Hbr_40y, color='orange')
#ax_h.plot(t, OC_storage_E2_Hbr40, color='darkturquoise')
ax_h.plot(t, Landfill_decomp_PF_FP_E2_Hbr_40y, color='yellow')
...
ax_g.set_title('Carbon flow, PF_FP_E_Hbr_40y')
#plt.plot(t, Cflow_PF_SF_S1)
#plt.plot(t, Cflow_PF_SF_S2)
#plt.plot(t, Cflow_PF_SF_E)
#plt.xlim([0, 200])
...
Agg_Cflow_S2_Ac_7y = [c_firewood_energy_S2_Ac7, decomp_tot_S2_Ac_7y, TestDSM2_Ac7.o, PH_Emissions_HWP2_Ac_7y, Landfill_decomp_PF_FP_S2_Ac_7y, flat_list_Ac_7y]
Agg_Cflow_S2_Ac_18y = [c_firewood_energy_S2_Ac18, decomp_tot_S2_Ac_18y, TestDSM2_Ac18.o, PH_Emissions_HWP2_Ac_18y, Landfill_decomp_PF_FP_S2_Ac_18y, flat_list_Ac_18y]
Agg_Cflow_S2_Tgr_60y = [c_firewood_energy_S2_Tgr60, decomp_tot_S2_Tgr_60y, TestDSM2_Tgr60.o, PH_Emissions_HWP2_Tgr_60y, Landfill_decomp_PF_FP_S2_Tgr_60y, flat_list_Tgr_60y]
Agg_Cflow_E2_Hbr_40y = [c_firewood_energy_E2_Hbr40, c_pellets_Hbr_40y, decomp_tot_E2_Hbr_40y, TestDSME2_Hbr40.o, PH_Emissions_HWPE2_Hbr_40y, Landfill_decomp_PF_FP_E2_Hbr_40y, flat_list_Hbr_40y]


Agg_Cflow_PF_FP_S2_Ac_7y = [sum(x) for x in zip(*Agg_Cflow_S2_Ac_7y)]
Agg_Cflow_PF_FP_S2_Ac_18y = [sum(x) for x in zip(*Agg_Cflow_S2_Ac_18y)]
Agg_Cflow_PF_FP_S2_Tgr_60y = [sum(x) for x in zip(*Agg_Cflow_S2_Tgr_60y)]
Agg_Cflow_PF_FP_E2_Hbr_40y = [sum(x) for x in zip(*Agg_Cflow_E2_Hbr_40y)]
...
# plot
ax5.plot(t, Agg_Cflow_PF_FP_S2_Ac_7y, color='orange', label='M_Ac_7y') 
ax5.plot(t, Agg_Cflow_PF_FP_S2_Ac_18y, color='darkturquoise', label='M_Ac_18y') 
ax5.plot(t, Agg_Cflow_PF_FP_S2_Tgr_60y, color='lightcoral', label='M_Tgr_60y')
ax5.plot(t, Agg_Cflow_PF_FP_E2_Hbr_40y, color='mediumseagreen', label='E_Hbr_40y')  
...
ax5.set_title('Aggr. C-emissions/sequestration flow, PF_FP (symlog-scale)')
...
#Create colum results
dfM_PF_FP = pd.DataFrame.from_dict({'Year':year,'M_Ac_7y (t-C)':Agg_Cflow_PF_FP_S2_Ac_7y, 'M_Ac_18y (t-C)':Agg_Cflow_PF_FP_S2_Ac_18y,
                                         'M_Tgr_60y (t-C)':Agg_Cflow_PF_FP_S2_Tgr_60y, 'E_Hbr_40y (t-C)':Agg_Cflow_PF_FP_E2_Hbr_40y})

    
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_FP_Rel.xlsx', engine = 'xlsxwriter')


dfM_PF_FP.to_excel(writer, sheet_name = 'PF_FP', header=True, index=False)
...
# plot
ax5a.plot(t, Agg_Cflow_PF_FP_S2_Ac_7y, color='orange', label='M_Ac_7y') 
ax5a.plot(t, Agg_Cflow_PF_FP_S2_Ac_18y, color='darkturquoise', label='M_Ac_18y') 
ax5a.plot(t, Agg_Cflow_PF_FP_S2_Tgr_60y, color='lightcoral', label='M_Tgr_60y')
ax5a.plot(t, Agg_Cflow_PF_FP_E2_Hbr_40y, color='mediumseagreen', label='E_Hbr_40y')

ax5a.plot(t, zerolistmaker(tf-1), color='black', label='Zero line', ls='--', alpha=0.75)


ax5b.plot(t, Agg_Cflow_PF_FP_S2_Ac_7y, color='orange')
ax5b.plot(t, Agg_Cflow_PF_FP_S2_Ac_18y, color='darkturquoise')
ax5b.plot(t, Agg_Cflow_PF_FP_S2_Tgr_60y, color='lightcoral')
ax5b.plot(t, Agg_Cflow_PF_FP_E2_Hbr_40y, color='mediumseagreen')
...
ax5a.set_title('Net carbon balance, PF_FP')
...
OC_storage_S2_Ac7 = df2_Ac7['Other_C_storage'].values


OC_storage_S2_Ac7 = [x/division for x in OC_storage_S2_Ac7]
OC_storage_S2_Ac7 = [abs(number) for number in OC_storage_S2_Ac7]

C_LF_S2_Ac7 = [x*1/0.82 for x in OC_storage_S2_Ac7]


## define the input flow from the logging/harvesting to wood materials/pellets processing (F2-3)
HWP_S2_Ac7 = [x/division for x in df2_Ac7['Input_PF'].values]
HWP_S2_Ac7_energy =  [x*1/3 for x in c_firewood_energy_S2_Ac7]
HWP_S2_Ac7_landfill = [x*1/0.82 for x in OC_storage_S2_Ac7]

HWP_S2_Ac7_sum = [HWP_S2_Ac7, HWP_S2_Ac7_energy, HWP_S2_Ac7_landfill]
HWP_S2_Ac7_sum = [sum(x) for x in zip(*HWP_S2_Ac7_sum )]

#in-use stocks (S-4)
TestDSM2_Ac7.s = [x/division for x in TestDSM2_Ac7.s]
...
zero_matrix_stocks_S2_Ac_7y = (tf,1)
stocks_S2_Ac_7y = np.zeros(zero_matrix_stocks_S2_Ac_7y)


i = 0
stocks_S2_Ac_7y[0] = C_LF_S2_Ac7[0] - Landfill_decomp_PF_FP_S2_Ac_7y[0]

while i < tf-1:
    stocks_S2_Ac_7y[i+1] = np.array(C_LF_S2_Ac7[i+1] - Landfill_decomp_PF_FP_S2_Ac_7y[i+1] + stocks_S2_Ac_7y[i])
    i = i + 1



## calculate aggregate flow of logged wood (F1-2)
HWP_logged_S2_Ac_7y = [x1+x2 for (x1,x2) in zip(HWP_S2_Ac7_sum, [x*2/3 for x in c_firewood_energy_S2_Ac7])] 


## calculate the stocks in the forest (AGB + undecomposed residue) (S-1a+S-1c)
tf = 201

zero_matrix_ForCstocks_S2_Ac_7y = (tf,1)
ForCstocks_S2_Ac_7y = np.zeros(zero_matrix_ForCstocks_S2_Ac_7y)

i = 0
ForCstocks_S2_Ac_7y[0] = initAGB - flat_list_Ac_7y[0] - decomp_tot_S2_Ac_7y[0] - HWP_logged_S2_Ac_7y[0]

while i < tf-1:
    ForCstocks_S2_Ac_7y[i+1] = np.array(ForCstocks_S2_Ac_7y[i] - flat_list_Ac_7y[i+1] - decomp_tot_S2_Ac_7y[i+1] - HWP_logged_S2_Ac_7y[i+1])
    i = i + 1


##NonRW materials/energy amount (F9-0-1)
df2_amount_Ac7 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_PF_FP.xlsx', 'PF_FP_S2_Ac_7y')
NonRW_amount_S2_Ac_7y = df2_amount_Ac7['NonRW_amount'].values

NonRW_amount_S2_Ac_7y = [x/1000 for x in NonRW_amount_S2_Ac_7y]



##NonRW emissions (F9-0-2)
emissions_NonRW_S2_Ac_7y = [x/division for x in emissions_NonRW_S2_Ac_7y]
    

#create columns
dfM_Ac_7y = pd.DataFrame.from_dict({'Year':Column1, 
                                    'F0-1 (t-C)': flat_list_Ac_7y,
                                    'F1-0 (t-C)': decomp_tot_S2_Ac_7y,
                                    #'F1a-2 (t-C)': PF_S2_Ac_7y,
                                    #'F1c-2 (t-C)': FP_S2_Ac_7y,
                                    'F1-2 (t-C)': HWP_logged_S2_Ac_7y, 
                                    'St-1 (t-C)':ForCstocks_S2_Ac_7y[:,0], 
                                    'F2-3 (t-C)': HWP_S2_Ac7_sum,  
                                    'F2-6 (t-C)': [x*2/3 for x in c_firewood_energy_S2_Ac7], 
                                    'SM/E (t-C)': [x1-x2-x3 for (x1,x2,x3) in zip(HWP_S2_Ac7_sum, [x*1/0.82 for x in OC_storage_S2_Ac7], [x*1/3 for x in c_firewood_energy_S2_Ac7])],
                                    'F3-5 (t-C)':[x*1/0.82 for x in OC_storage_S2_Ac7],
                                    'F3-6 (t-C)': [x*1/3 for x in c_firewood_energy_S2_Ac7], 
                                   # 'F4-0 (t-C)':,
                                    'St-4 (t-C)': TestDSM2_Ac7.s, 
                                    #'S-4-i (t-C)': TestDSM2_Ac7.i,
                                    'F4-5 (t-C)': TestDSM2_Ac7.o,
                                    'F5-6 (t-C)': TestDSM2_Ac7.o, 
                                    'F5-7 (t-C)': C_LF_S2_Ac7,
                                    'F6-0-1 (t-C)': c_firewood_energy_S2_Ac7,
                                    'F6-0-2 (t-C)': TestDSM2_Ac7.o,
                                    'St-7 (t-C)': stocks_S2_Ac_7y[:,0],
                                    'F7-0 (t-C)': Landfill_decomp_PF_FP_S2_Ac_7y,
                                    'F8-0 (t-C)': PH_Emissions_HWP2_Ac_7y,
                                    'S9-0 (t)': NonRW_amount_S2_Ac_7y, 
                                    'F9-0 (t-C)': emissions_NonRW_S2_Ac_7y,
                                    })
...
i = 0
stocks_S2_Ac_18y[0] = C_LF_S2_Ac18[0] - Landfill_decomp_PF_FP_S2_Ac_18y[0]

while i < tf-1:
    stocks_S2_Ac_18y[i+1] = np.array(C_LF_S2_Ac18[i+1] - Landfill_decomp_PF_FP_S2_Ac_18y[i+1] + stocks_S2_Ac_18y[i])
    i = i + 1
...
##NonRW materials/energy amount (F9-0-1)
df2_amount_Ac18 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_PF_FP.xlsx', 'PF_FP_S2_Ac_18y')
...
dfM_Ac_18y = pd.DataFrame.from_dict({'Year':Column1, 
                                   ...
                                   # 'F4-0 (t-C)':,
                                    ...
                                    'F7-0 (t-C)': Landfill_decomp_PF_FP_S2_Ac_18y,
...
i = 0
stocks_S2_Tgr_60y[0] = C_LF_S2_Tgr60[0] - Landfill_decomp_PF_FP_S2_Tgr_60y[0]

while i < tf-1:
    stocks_S2_Tgr_60y[i+1] = np.array(C_LF_S2_Tgr60[i+1] - Landfill_decomp_PF_FP_S2_Tgr_60y[i+1] + stocks_S2_Tgr_60y[i])
    i = i + 1
...
##NonRW materials/energy amount (F9-0-1)
df2_amount_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_PF_FP.xlsx', 'PF_FP_S2_Tgr_60y')
...
dfM_Tgr_60y = pd.DataFrame.from_dict({'Year':Column1, 
                                    ...
                                    'F1-0 (t-C)': decomp_tot_S2_Tgr_60y,
                                   ...
                                   # 'F4-0 (t-C)':,
                                    ...
                                    'F7-0 (t-C)': Landfill_decomp_PF_FP_S2_Tgr_60y,
...
i = 0
stocks_E2_Hbr_40y[0] = C_LF_E2_Hbr40[0] - Landfill_decomp_PF_FP_E2_Hbr_40y[0]

while i < tf-1:
    stocks_E2_Hbr_40y[i+1] = np.array(C_LF_E2_Hbr40[i+1] - Landfill_decomp_PF_FP_E2_Hbr_40y[i+1] + stocks_E2_Hbr_40y[i])
    i = i + 1
...
##NonRW materials/energy amount (F9-0-1)
dfE2_amount_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_PF_FP.xlsx', 'PF_FP_E2_Hbr_40y')
...
dfE2_Hbr_40y = pd.DataFrame.from_dict({'Year':Column1, 
                                    ...
                                    'F1-0 (t-C)': decomp_tot_E2_Hbr_40y,
                                    #'F1a-2 (t-C)': PF_S2_Tgr_60y,
                                    #'F1c-2 (t-C)': FP_S2_Tgr_60y,
                                    ...
                                    'F7-0 (t-C)': Landfill_decomp_PF_FP_E2_Hbr_40y,
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_FP_Rel.xlsx', engine = 'xlsxwriter')


dfM_Ac_7y.to_excel(writer, sheet_name = 'PF_FP_M_Ac_7y', header=True, index=False)
dfM_Ac_18y.to_excel(writer, sheet_name = 'PF_FP_M_Ac_18y', header=True, index=False)
dfM_Tgr_60y.to_excel(writer, sheet_name = 'PF_FP_M_Tgr_60y', header=True, index=False)
dfE2_Hbr_40y.to_excel(writer, sheet_name = 'PF_FP_E2_Hbr_40y', header=True, index=False)
