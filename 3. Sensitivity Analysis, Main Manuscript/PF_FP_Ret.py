...
df = pd.DataFrame.from_dict({'Year':Column1, 
                                    'Ac_7y': TestDSM2_Ac7.o,
                                    'Ac_18y': TestDSM2_Ac18.o,
                                    'Tgr_60y': TestDSM2_Tgr60.o,
                                    'Hbr_40y': TestDSME2_Hbr40.o,
                                      })

writer = pd.ExcelWriter('OutDSM_PF_FP_Ret.xlsx', engine = 'xlsxwriter')


df.to_excel(writer, sheet_name = 'PF_FP_Ret', header=True, index=False)
...
#S2_Ac_7y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Ret.xlsx', 'PF_FP_S2_Ac_7y')
...
#S2_Ac_18y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Ret.xlsx', 'PF_FP_S2_Ac_18y')
...
#S2_Tgr_40y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Ret.xlsx', 'PF_FP_S2_Tgr_40y')
...
#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Ret.xlsx', 'PF_FP_S2_Tgr_60y')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Ret.xlsx', 'PF_FP_E2_Hbr_40y')
...
TestDSM2_Ac7.o = [x * 0.5 for x in TestDSM2_Ac7.o]
TestDSM2_Ac18.o = [x * 0.5 for x in TestDSM2_Ac18.o]
TestDSM2_Tgr40.o = [x * 0.5 for x in TestDSM2_Tgr40.o]
TestDSM2_Tgr60.o = [x * 0.5 for x in TestDSM2_Tgr60.o]
TestDSME2_Hbr40.o = [x * 0.5 for x in TestDSME2_Hbr40.o]


Emissions_S2_Ac_7y = [c_firewood_energy_S2_Ac7, decomp_tot_S2_Ac_7y[:,0], TestDSM2_Ac7.o, PH_Emissions_HWP2_Ac_7y, decomp_tot_CO2_S2_Ac_7y[:,0]]
...
Emissions_S2_Tgr_40y = [c_firewood_energy_S2_Tgr40, decomp_tot_S2_Tgr_40y[:,0], TestDSM2_Tgr40.o, PH_Emissions_HWP2_Tgr_40y, decomp_tot_CO2_S2_Tgr_40y[:,0]]
...
writer = pd.ExcelWriter('emissions_seq_PF_FP_Ret.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_PF_FP_Ret.xlsx', 'PF_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_PF_FP_Ret.xlsx', 'PF_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_PF_FP_Ret.xlsx', 'PF_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_PF_FP_Ret.xlsx', 'PF_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_PF_FP_Ret.xlsx', 'PF_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_FP_Ret.xlsx', engine = 'xlsxwriter')
...
decomp_tot_S2_Ac_7y[:,0] = [x/division for x in decomp_tot_S2_Ac_7y[:,0]]
...
writer = pd.ExcelWriter('C_flows_PF_FP_Ret.xlsx', engine = 'xlsxwriter')
...
ax1.plot(t, decomp_tot_S2_Ac_7y[:,0], color='lightcoral', label='F1-0: Residue decomposition')
...
ax_a.plot(t, decomp_tot_S2_Ac_7y[:,0], color='lightcoral', label='F1-0: Residue decomposition')
...
ax_b.plot(t, decomp_tot_S2_Ac_7y[:,0], color='lightcoral')
...
ax_c.plot(t, decomp_tot_S2_Ac_18y[:,0], color='lightcoral', label='F1-0: Residue decomposition')
...
ax_d.plot(t, decomp_tot_S2_Ac_18y[:,0], color='lightcoral')
...
ax_e.plot(t, decomp_tot_S2_Tgr_60y[:,0], color='lightcoral', label='F1-0: Residue decomposition')
...
ax_f.plot(t, decomp_tot_S2_Tgr_60y[:,0],color='lightcoral')
...
ax_g.plot(t, decomp_tot_E2_Hbr_40y[:,0], color='lightcoral', label='F1-0: Residue decomposition')
...
ax_h.plot(t, decomp_tot_E2_Hbr_40y[:,0], color='lightcoral')
...
Agg_Cflow_S2_Ac_7y = [c_firewood_energy_S2_Ac7, decomp_tot_S2_Ac_7y[:,0], TestDSM2_Ac7.o, PH_Emissions_HWP2_Ac_7y, Landfill_decomp_PF_FP_S2_Ac_7y, flat_list_Ac_7y]
Agg_Cflow_S2_Ac_18y = [c_firewood_energy_S2_Ac18, decomp_tot_S2_Ac_18y[:,0], TestDSM2_Ac18.o, PH_Emissions_HWP2_Ac_18y, Landfill_decomp_PF_FP_S2_Ac_18y, flat_list_Ac_18y]
Agg_Cflow_S2_Tgr_60y = [c_firewood_energy_S2_Tgr60, decomp_tot_S2_Tgr_60y[:,0], TestDSM2_Tgr60.o, PH_Emissions_HWP2_Tgr_60y, Landfill_decomp_PF_FP_S2_Tgr_60y, flat_list_Tgr_60y]
Agg_Cflow_E2_Hbr_40y = [c_firewood_energy_E2_Hbr40, c_pellets_Hbr_40y, decomp_tot_E2_Hbr_40y[:,0], TestDSME2_Hbr40.o, PH_Emissions_HWPE2_Hbr_40y, Landfill_decomp_PF_FP_E2_Hbr_40y, flat_list_Hbr_40y]
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_FP_Ret.xlsx', engine = 'xlsxwriter')
...
dfM_Ac_7y = pd.DataFrame.from_dict({'Year':Column1, 
                                    ...
                                    'F1-0 (t-C)': decomp_tot_S2_Ac_7y[:,0],
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_FP_Ret.xlsx', engine = 'xlsxwriter')
