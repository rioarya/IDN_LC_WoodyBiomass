...
df2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_S2')
df3 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_E')
...
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_E')
...
#S2
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_S2')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_E')
...
#df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_S1')
df2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_S2')
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_E')
...
#TestDSM1 = DynamicStockModel(t = df1['Year'].values, i = df1['Input_PF'].values, lt = {'Type': 'Normal', 'Mean': np.array([35]), 'StdDev': np.array([10.5])})
...
#S2
df2_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_S2')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_E')
...
#S2
df2_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_S2')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'PF_SF_E')
...
#Emissions_PF_SF_S1 = [c_loss_S1, decomp_tot_S1[:,0], subs_S1, TestDSM1.o, PH_Emissions_HWP1_S1, OC_storage_S1, decomp_tot_CO2_S1[:,0]]
...
writer = pd.ExcelWriter('emissions_seq_PF_SF_LF50.xlsx', engine = 'xlsxwriter')
...
#wood-based 
#read S2_moist
df = pd.read_excel('emissions_seq_PF_SF_LF50.xlsx', 'S2_moist') # can also index sheet by name or fetch all sheets
...
#read S2_dry
df = pd.read_excel('emissions_seq_PF_SF_LF50.xlsx', 'S2_dry')
...
#read E_moist
df = pd.read_excel('emissions_seq_PF_SF_LF50.xlsx', 'E_moist') # can also index sheet by name or fetch all sheets
...
#read E_dry
df = pd.read_excel('emissions_seq_PF_SF_LF50.xlsx', 'E_dry')
...
#read S2
df = pd.read_excel('PF_SF_LF50.xlsx', 'NonRW_PF_SF_S2') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('PF_SF_LF50.xlsx', 'NonRW_PF_SF_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_SF_LF50.xlsx', engine = 'xlsxwriter')
...
#Landfill_flows_S1 = OC_storage_S1, decomp_tot_CH4_S1, decomp_tot_CO2_S1
...
#Landfill_flows_S1 = [sum(x) for x in zip(*Landfill_flows_S1)]
Landfill_decomp_S2 = [sum(x) for x in zip(*Landfill_decomp_S2)]
Landfill_decomp_E = [sum(x) for x in zip(*Landfill_decomp_E)]

#Landfill_flows_S1 = [item for sublist in Landfill_flows_S1 for item in sublist]
...
#print(Landfill_flows_S2)
#print(type(Landfill_flows_S2))
...
writer = pd.ExcelWriter('C_flows_PF_SF_LF50.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_SF_LF50.xlsx', engine = 'xlsxwriter')
...
df2_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'NonRW_PF_SF_S2')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_LF50.xlsx', 'NonRW_PF_SF_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_SF_LF50.xlsx', engine = 'xlsxwriter')
