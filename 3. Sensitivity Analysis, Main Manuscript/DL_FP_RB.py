...
#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP.xlsx', 'DL_FP_S2_Tgr_60y')
...
writer = pd.ExcelWriter('emissions_seq_DL_FP_RB.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_DL_FP_RB.xlsx', 'DL_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_DL_FP_RB.xlsx', 'DL_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_DL_FP_RB.xlsx', 'DL_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_DL_FP_RB.xlsx', 'DL_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_DL_FP_RB.xlsx', 'DL_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_DL_FP_RB.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_DL_FP_RB.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_DL_FP_RB.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_DL_FP_RB.xlsx', engine = 'xlsxwriter')
