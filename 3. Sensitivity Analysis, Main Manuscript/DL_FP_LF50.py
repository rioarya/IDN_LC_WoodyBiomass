...
df2_Ac7 = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Ac_7y')
df2_Ac18 = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Ac_18y')
df2_Tgr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Tgr_40y')
df2_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Tgr_60y')
dfE2_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_E2_Hbr_40y')
...
dfE2 = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_E2_Hbr_40y')
...
#S2_Ac_7y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Ac_7y')
...
#S2_Ac_18y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Ac_18y')
...
#S2_Tgr_40y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Tgr_40y')
...
#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S1_Tgr_60y')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_E2_Hbr_40y')
...
df2_Ac_7y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Ac_7y')
df2_Ac_18y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Ac_18y')
df2_Tgr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Tgr_40y')
df2_Tgr_60y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Tgr_60y')
dfE2_Hbr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_E2_Hbr_40y')
...
#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_LF50.xlsx', 'DL_FP_S2_Tgr_60y')
...
writer = pd.ExcelWriter('emissions_seq_DL_FP_LF50.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_DL_FP_LF50.xlsx', 'DL_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_DL_FP_LF50.xlsx', 'DL_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_DL_FP_LF50.xlsx', 'DL_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_DL_FP_LF50.xlsx', 'DL_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_DL_FP_LF50.xlsx', 'DL_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_DL_FP_LF50.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_DL_FP_LF50.xlsx', engine = 'xlsxwriter')
...
ax1_s.plot(t, decomp_tot_S2_Ac_7y[:,0], color='lightcoral', label='F1-0: Residue decomposition')
...
Agg_Cflow_S2_Ac_7y = [c_firewood_energy_S2_Ac7, decomp_tot_S2_Ac_7y[:,0], TestDSM2_Ac7.o, PH_Emissions_HWP2_Ac_7y, Landfill_decomp_DL_FP_S2_Ac_7y, flat_list_Ac_7y]
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_DL_FP_LF50.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_DL_FP_LF50.xlsx', engine = 'xlsxwriter')
