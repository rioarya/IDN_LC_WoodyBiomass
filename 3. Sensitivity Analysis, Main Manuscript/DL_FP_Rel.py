...
df2_Ac_7y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP.xlsx', 'DL_FP_S2_Ac_7y')
df2_Ac_18y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP.xlsx', 'DL_FP_S2_Ac_18y')
df2_Tgr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP.xlsx', 'DL_FP_S2_Tgr_40y')
df2_Tgr_60y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP.xlsx', 'DL_FP_S2_Tgr_60y')
dfE2_Hbr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP.xlsx', 'DL_FP_E2_Hbr_40y')
...
#S2_Ac_7y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_Rel.xlsx', 'DL_FP_S2_Ac_7y')
...
#S2_Ac_18y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_Rel.xlsx', 'DL_FP_S2_Ac_18y')
...
#S2_Tgr_40y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_Rel.xlsx', 'DL_FP_S2_Tgr_40y')
...
#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_Rel.xlsx', 'DL_FP_S2_Tgr_60y')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\DL_FP_Rel.xlsx', 'DL_FP_E2_Hbr_40y')
...
Emissions_DL_FP_S2_Ac_7y = [sum(x) for x in zip(*Emissions_S2_Ac_7y)]
Emissions_DL_FP_S2_Ac_18y = [sum(x) for x in zip(*Emissions_S2_Ac_18y)]
Emissions_DL_FP_S2_Tgr_40y = [sum(x) for x in zip(*Emissions_S2_Tgr_40y)]
...
#CH4_S2_Ac_7y
Emissions_CH4_DL_FP_S2_Ac_7y = decomp_tot_CH4_S2_Ac_7y[:,0]
...
#CH4_S2_Tgr_40y
Emissions_CH4_DL_FP_S2_Tgr_40y = decomp_tot_CH4_S2_Tgr_40y[:,0]
...
Col1 = year
Col2_S2_Ac_7y = Emissions_DL_FP_S2_Ac_7y
Col2_S2_Ac_18y = Emissions_DL_FP_S2_Ac_18y
Col2_S2_Tgr_40y = Emissions_DL_FP_S2_Tgr_40y
Col2_S2_Tgr_60y = Emissions_DL_FP_S2_Tgr_60y
Col2_E2_Hbr_40y = Emissions_DL_FP_E2_Hbr_40y

Col3_S2_Ac_7y = Emissions_CH4_DL_FP_S2_Ac_7y
Col3_S2_Ac_18y = Emissions_CH4_DL_FP_S2_Ac_18y
Col3_S2_Tgr_40y = Emissions_CH4_DL_FP_S2_Tgr_40y
...
writer = pd.ExcelWriter('emissions_seq_DL_FP_Rel.xlsx', engine = 'xlsxwriter')

df2_Ac_7y.to_excel(writer, sheet_name = 'DL_FP_S2_Ac_7y', header=True, index=False )
df2_Ac_18y.to_excel(writer, sheet_name = 'DL_FP_S2_Ac_18y', header=True, index=False)
df2_Tgr_40y.to_excel(writer, sheet_name = 'DL_FP_S2_Tgr_40y', header=True, index=False)
df2_Tgr_60y.to_excel(writer, sheet_name = 'DL_FP_S2_Tgr_60y', header=True, index=False)
dfE2_Hbr_40y.to_excel(writer, sheet_name = 'DL_FP_E2_Hbr_40y', header=True, index=False)
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_DL_FP_Rel.xlsx', 'DL_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_DL_FP_Rel.xlsx', 'DL_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_DL_FP_Rel.xlsx', 'DL_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_DL_FP_Rel.xlsx', 'DL_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_DL_FP_Rel.xlsx', 'DL_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_7y
df = pd.read_excel('NonRW_DL_FP.xlsx', 'DL_FP_S2_Ac_7y')
...
#read S2_Ac_18y
df = pd.read_excel('NonRW_DL_FP.xlsx', 'DL_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('NonRW_DL_FP.xlsx', 'DL_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
emissions_NonRW_S2_Tgr_40y = df['NonRW_emissions'].tolist()
emissions_NonRW_S2_Tgr_40y_seq = df['kg_CO2_seq'].tolist()


#read S2_Tgr_60y
df = pd.read_excel('NonRW_DL_FP.xlsx', 'DL_FP_S2_Tgr_60y')
emissions_NonRW_S2_Tgr_60y = df['NonRW_emissions'].tolist()
emissions_NonRW_S2_Tgr_60y_seq = df['kg_CO2_seq'].tolist()


#read E2_Hbr_40y
df = pd.read_excel('NonRW_DL_FP.xlsx', 'DL_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#plt.plot(t, GWI_inst_tot_NonRW_S2_Tgr_40y, color='lightcoral', label='NR_S2_Tgr_40y', ls='--', alpha=0.55)
...
#plt.plot(t, GWI_inst_tot_S2_Tgr_40y, color='lightcoral', label='M_Tgr_40y')
...
plt.title('Instantaneous GWI, DL_FP')
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWI_inst_NonRW_DL_FP_S2', dpi=300)
...
plt.xlim(0,200)
#plt.ylim(-3e-7,2.2e-7)
plt.ylim(-1e-7,2.3e-7)


plt.title('Cumulative GWI, DL_FP')
...
#plt.plot(t, GWI_cum_NonRW_S2_Tgr_40y, color='lightcoral', label='NR_S2_Tgr_40y', ls='--', alpha=0.55)
...
#plt.plot(t, GWI_cum_S2_Tgr_40y, color='lightcoral', label='M_Tgr_40y')
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWI_cum_DL_FP_S2', dpi=300)
...
#ax.plot(t, GWP_dyn_cum_S2_Tgr_40y, color='lightcoral', label='M_Tgr_40y')
...
ax.set_title('Dynamic GWP, DL_FP')


plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWP_dyn_cum_NonRW_DL_FP_S2', dpi=300)
...
dfM_GWPdyn = pd.DataFrame.from_dict({'Year':Col1,'M_Ac_7y (t-CO2-eq)':Col_GWP_1, 'M_Ac_18y (t-CO2-eq)':Col_GWP_2,
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_DL_FP_Rel.xlsx', engine = 'xlsxwriter')


dfM_GI.to_excel(writer, sheet_name = 'GWI_Inst_DL_FP', header=True, index=False )


dfM_GC.to_excel(writer, sheet_name = 'Cumulative GWI_DL_FP', header=True, index=False )


dfM_GWPdyn.to_excel(writer, sheet_name = 'GWPdyn_DL_FP', header=True, index=False )
...
Landfill_decomp_DL_FP_S2_Ac_7y = decomp_tot_CH4_S2_Ac_7y, decomp_tot_CO2_S2_Ac_7y
...
Landfill_decomp_DL_FP_S2_Ac_7y = [sum(x) for x in zip(*Landfill_decomp_DL_FP_S2_Ac_7y)]
...
Landfill_decomp_DL_FP_S2_Ac_7y = [item for sublist in Landfill_decomp_DL_FP_S2_Ac_7y for item in sublist]
...
Column6 = Landfill_decomp_DL_FP_S2_Ac_7y
...
writer = pd.ExcelWriter('C_flows_DL_FP_Rel.xlsx', engine = 'xlsxwriter')



dfM_Ac_7y.to_excel(writer, sheet_name = 'DL_FP_M_Ac_7y', header=True, index=False)
dfM_Ac_18y.to_excel(writer, sheet_name = 'DL_FP_M_Ac_18y', header=True, index=False)
dfE_Tgr_60y.to_excel(writer, sheet_name = 'DL_FP_M_Tgr_60y', header=True, index=False)
dfE_Hbr_40y.to_excel(writer, sheet_name = 'DL_FP_E2_Hbr_40y', header=True, index=False)
...
#ax1_s.plot(t, OC_storage_S2_Ac7, color='darkturquoise', label='9: Landfill storage') 
ax1_s.plot(t, decomp_tot_S2_Ac_7y, color='lightcoral', label='F1-0: Residue decomposition')
ax1_s.plot(t, c_firewood_energy_S2_Ac7, color='mediumseagreen', label='F6-0-1: Emissions from firewood/other energy use') 
ax1_s.plot(t, PH_Emissions_HWP2_Ac_7y, color='orange', label='F8-0: Operational stage/processing emissions')
ax1_s.plot(t, TestDSM2_Ac7.o, color='royalblue', label='F6-0-2: Energy use emissions from in-use stocks outflow')
ax1_s.plot(t, Landfill_decomp_DL_FP_S2_Ac_7y, color='yellow', label='F7-0: Landfill gas decomposition')
...
ax1_s.set_title('Carbon flow, DL_FP_M_Ac_7y (symlog-scale)')
...
#ax1.plot(t, OC_storage_S2_Ac7, color='darkturquoise', label='9: Landfill storage') 
...
ax1.plot(t, Landfill_decomp_DL_FP_S2_Ac_7y, color='yellow', label='F7-0: Landfill gas decomposition')
...
ax1.set_title('Carbon flow, DL_FP_M_Ac_7y')
...
ax2_s.plot(t, decomp_tot_S2_Ac_18y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax2_s.set_title('Carbon flow, DL_FP_M_Ac_18y (symlog-scale)')
...
ax2.set_title('Carbon flow, DL_FP_M_Ac_18y')
...
ax3_s.plot(t, decomp_tot_S2_Tgr_60y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax3_s.set_title('Carbon flow, DL_FP_M_Tgr_60y (symlog-scale)')
...
ax3.set_title('Carbon flow, DL_FP_M_Tgr_60y')
...
ax4_s.plot(t, decomp_tot_E2_Hbr_40y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax4_s.set_title('Carbon flow, DL_FP_E_Hbr_40y (symlog-scale)')
...
ax4.set_title('Carbon flow, DL_FP_E_Hbr_40y')
...
Agg_Cflow_S2_Ac_7y = [c_firewood_energy_S2_Ac7, decomp_tot_S2_Ac_7y, TestDSM2_Ac7.o, PH_Emissions_HWP2_Ac_7y, Landfill_decomp_DL_FP_S2_Ac_7y, flat_list_Ac_7y]
Agg_Cflow_S2_Ac_18y = [c_firewood_energy_S2_Ac18, decomp_tot_S2_Ac_18y, TestDSM2_Ac18.o, PH_Emissions_HWP2_Ac_18y, Landfill_decomp_DL_FP_S2_Ac_18y, flat_list_Ac_18y]
Agg_Cflow_S2_Tgr_60y = [c_firewood_energy_S2_Tgr60, decomp_tot_S2_Tgr_60y, TestDSM2_Tgr60.o, PH_Emissions_HWP2_Tgr_60y, Landfill_decomp_DL_FP_S2_Tgr_60y, flat_list_Tgr_60y]
Agg_Cflow_E2_Hbr_40y = [c_firewood_energy_E2_Hbr40, c_pellets_Hbr_40y, decomp_tot_E2_Hbr_40y, TestDSME2_Hbr40.o, PH_Emissions_HWPE2_Hbr_40y, Landfill_decomp_DL_FP_E2_Hbr_40y, flat_list_Hbr_40y]


Agg_Cflow_DL_FP_S2_Ac_7y = [sum(x) for x in zip(*Agg_Cflow_S2_Ac_7y)]
...
#Create colum results
dfM_DL_FP = pd.DataFrame.from_dict({'Year':year,'M_Ac_7y (t-C)':Agg_Cflow_DL_FP_S2_Ac_7y, 'M_Ac_18y (t-C)':Agg_Cflow_DL_FP_S2_Ac_18y,
                                         'M_Tgr_60y (t-C)':Agg_Cflow_DL_FP_S2_Tgr_60y, 'E_Hbr_40y (t-C)':Agg_Cflow_DL_FP_E2_Hbr_40y})

    
#Export to excel
writer = pd.ExcelWriter('AggCFlow_DL_FP_Rel.xlsx', engine = 'xlsxwriter')


dfM_DL_FP.to_excel(writer, sheet_name = 'DL_FP', header=True, index=False)
...
ax5.plot(t, Agg_Cflow_DL_FP_S2_Ac_7y, color='orange', label='M_Ac_7y') 
ax5.plot(t, Agg_Cflow_DL_FP_S2_Ac_18y, color='darkturquoise', label='M_Ac_18y') 
ax5.plot(t, Agg_Cflow_DL_FP_S2_Tgr_60y, color='lightcoral', label='M_Tgr_60y')
ax5.plot(t, Agg_Cflow_DL_FP_E2_Hbr_40y, color='mediumseagreen', label='E_Hbr_40y')  
...
ax5.set_title('Net carbon balance, DL_FP')
...
i = 0
stocks_S2_Ac_7y[0] = C_LF_S2_Ac7[0] - Landfill_decomp_DL_FP_S2_Ac_7y[0]

while i < tf-1:
    stocks_S2_Ac_7y[i+1] = np.array(C_LF_S2_Ac7[i+1] - Landfill_decomp_DL_FP_S2_Ac_7y[i+1] + stocks_S2_Ac_7y[i])
    i = i + 1
...
df2_amount_Ac7 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_DL_FP.xlsx', 'DL_FP_S2_Ac_7y')
...
dfM_Ac_7y = pd.DataFrame.from_dict({'Year':Column1, 
                                   ...
                                   # 'F4-0 (t-C)':,
                                    ...
                                    'F7-0 (t-C)': Landfill_decomp_DL_FP_S2_Ac_7y,
...
##NonRW materials/energy amount (F9-0-1)
df2_amount_Ac18 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_DL_FP.xlsx', 'DL_FP_S2_Ac_18y')
...
##NonRW materials/energy amount (F9-0-1)
df2_amount_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_DL_FP.xlsx', 'DL_FP_S2_Tgr_60y')
...
##NonRW materials/energy amount (F9-0-1)
dfE2_amount_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_DL_FP.xlsx', 'DL_FP_E2_Hbr_40y')
...
writer = pd.ExcelWriter('C_flows_SysDef_DL_FP_Rel.xlsx', engine = 'xlsxwriter')


dfM_Ac_7y.to_excel(writer, sheet_name = 'DL_FP_M_Ac_7y', header=True, index=False)
dfM_Ac_18y.to_excel(writer, sheet_name = 'DL_FP_M_Ac_18y', header=True, index=False)
dfM_Tgr_60y.to_excel(writer, sheet_name = 'DL_FP_M_Tgr_60y', header=True, index=False)
dfE2_Hbr_40y.to_excel(writer, sheet_name = 'DL_FP_E2_Hbr_40y', header=True, index=False)
