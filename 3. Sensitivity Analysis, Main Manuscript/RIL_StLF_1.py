...
#read S2
df = pd.read_excel('RIL_StLF.xlsx', 'NonRW_RIL_S2')
emission_NonRW_RIL_S2 = df['NonRW_emissions'].tolist()
emission_NonRW_RIL_S2_seq = df['kg_CO2_seq'].tolist()


#read E
df = pd.read_excel('RIL_StLF.xlsx', 'NonRW_RIL_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_RIL_StLF.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_RIL_StLF.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_RIL_StLF.xlsx', engine = 'xlsxwriter')
...
plt.savefig('NCB RIL_StLF.png', dpi=300)
...
df2_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_StLF.xlsx', 'NonRW_RIL_S2')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_StLF.xlsx', 'NonRW_RIL_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_RIL_StLF.xlsx', engine = 'xlsxwriter')
