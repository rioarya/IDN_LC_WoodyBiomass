...
#S2
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Rel.xlsx', 'PF_SF_S2')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Rel.xlsx', 'PF_SF_E')
...
#S2
df2_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Rel.xlsx', 'PF_SF_S2')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Rel.xlsx', 'PF_SF_E')
...
#S2
df2_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Rel.xlsx', 'PF_SF_S2')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_Rel.xlsx', 'PF_SF_E')
...
Emissions_PF_SF_S2 = [c_firewood_energy_S2, decomp_tot_S2, TestDSM2.o, PH_Emissions_HWP1_S2, decomp_tot_CO2_S2[:,0]]
...
writer = pd.ExcelWriter('emissions_seq_PF_SF_Rel.xlsx', engine = 'xlsxwriter')
...
#wood-based 
#read S2_moist
df = pd.read_excel('emissions_seq_PF_SF_Rel.xlsx', 'S2_moist') # can also index sheet by name or fetch all sheets
...
#read S2_dry
df = pd.read_excel('emissions_seq_PF_SF_Rel.xlsx', 'S2_dry')
...
#read E_moist
df = pd.read_excel('emissions_seq_PF_SF_Rel.xlsx', 'E_moist') # can also index sheet by name or fetch all sheets
...
#read E_dry
df = pd.read_excel('emissions_seq_PF_SF_Rel.xlsx', 'E_dry')
...
#read S2
df = pd.read_excel('PF_SF_Rel.xlsx', 'NonRW_PF_SF_S2') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('PF_SF_Rel.xlsx', 'NonRW_PF_SF_E') # can also index sheet by name or fetch all sheets
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWI_inst_Non_RW_PF_SF', dpi=300)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWI_cum_NonRW_PF_SF', dpi=300)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWP_dyn_cum_NonRW_PF_SF', dpi=300)
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_SF_Rel.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_SF_Rel.xlsx', engine = 'xlsxwriter')
...
ax_a.plot(t, decomp_tot_S2, color='lightcoral', label='F1-0: Residue decomposition')
...
ax_b.plot(t, decomp_tot_S2, color='lightcoral')
...
Agg_Cflow_PF_SF_S2moi = [c_firewood_energy_S2, decomp_tot_S2, TestDSM2.o, PH_Emissions_HWP1_S2, Landfill_decomp_S2, flat_list_moist]
Agg_Cflow_PF_SF_S2dry = [c_firewood_energy_S2, decomp_tot_S2, TestDSM2.o, PH_Emissions_HWP1_S2, Landfill_decomp_S2, flat_list_dry]
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_SF_Rel.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_SF_Rel.xlsx', engine = 'xlsxwriter')
