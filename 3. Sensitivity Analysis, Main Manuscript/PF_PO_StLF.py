...
writer = pd.ExcelWriter('OutDSM_PF_PO_StLF.xlsx', engine = 'xlsxwriter')


df.to_excel(writer, sheet_name = 'PF_PO_StLF', header=True, index=False)
...
#S2nu
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_StLF.xlsx', 'PF_PO_S2nu')
...
#S2pl
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_StLF.xlsx', 'PF_PO_S2pl')
...
#Enu
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_StLF.xlsx', 'PF_PO_Enu')
...
#Epl
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_StLF.xlsx', 'PF_PO_Epl')
...
writer = pd.ExcelWriter('emissions_seq_PF_PO_StLF.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_nucleus
df = pd.read_excel('emissions_seq_PF_PO_StLF.xlsx', 'S2_nucleus') # can also index sheet by name or fetch all sheets
...
#read S2_plasma
df = pd.read_excel('emissions_seq_PF_PO_StLF.xlsx', 'S2_plasma')
...
#read E_nucleus
df = pd.read_excel('emissions_seq_PF_PO_StLF.xlsx', 'E_nucleus') # can also index sheet by name or fetch all sheets
...
#read E_plasma
df = pd.read_excel('emissions_seq_PF_PO_StLF.xlsx', 'E_plasma')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_PO_StLF.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_PO_StLF.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_PO_StLF.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_PO_StLF.xlsx', engine = 'xlsxwriter')
