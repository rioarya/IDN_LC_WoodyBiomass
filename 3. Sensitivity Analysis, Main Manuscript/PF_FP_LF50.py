...
df2_Ac7 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Ac_7y')
df2_Ac18 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Ac_18y')
df2_Tgr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Tgr_40y')
df2_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Tgr_60y')
dfE2_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_E2_Hbr_40y')
...
dfE2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_E2_Hbr_40y')
...
#S2_Ac_7y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Ac_7y')
...
#S2_Ac_18y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Ac_18y')
...
#S2_Tgr_40y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Tgr_40y')
...
#S2_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Tgr_60y')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_E2_Hbr_40y')
...
df2_Ac_7y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Ac_7y')
df2_Ac_18y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Ac_18y')
df2_Tgr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Tgr_40y')
df2_Tgr_60y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_S2_Tgr_60y')
dfE2_Hbr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_LF50.xlsx', 'PF_FP_E2_Hbr_40y')
...
#need to check this again, why are the results 'Nan'? 
...
writer = pd.ExcelWriter('emissions_seq_PF_FP_LF50.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_PF_FP_LF50.xlsx', 'PF_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_PF_FP_LF50.xlsx', 'PF_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_PF_FP_LF50.xlsx', 'PF_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_PF_FP_LF50.xlsx', 'PF_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_PF_FP_LF50.xlsx', 'PF_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_FP_LF50.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_FP_LF50.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_FP_LF50.xlsx', engine = 'xlsxwriter')
...
ax5a.set_title('Aggr. C-emissions/sequestration flow, PF_FP')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_FP_LF50.xlsx', engine = 'xlsxwriter')
