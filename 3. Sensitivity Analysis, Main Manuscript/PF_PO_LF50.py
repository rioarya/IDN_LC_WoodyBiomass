...
df2nu = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_S2nu')
df2pl = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_S2pl')
df3nu = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_Enu')
df3pl = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_Epl')
...
dfEnu = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_Enu')
dfEpl = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_Epl')
...
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_S2nu')
...
#S2pl
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_S2pl')
...
#Enu
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_Enu')
...
#Epl
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_LF50.xlsx', 'PF_PO_Epl')
...
writer = pd.ExcelWriter('emissions_seq_PF_PO_LF50.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_nucleus
df = pd.read_excel('emissions_seq_PF_PO_LF50.xlsx', 'S2_nucleus') # can also index sheet by name or fetch all sheets
...
#read S2_plasma
df = pd.read_excel('emissions_seq_PF_PO_LF50.xlsx', 'S2_plasma')
...
#read E_nucleus
df = pd.read_excel('emissions_seq_PF_PO_LF50.xlsx', 'E_nucleus') # can also index sheet by name or fetch all sheets
...
#read E_plasma
df = pd.read_excel('emissions_seq_PF_PO_LF50.xlsx', 'E_plasma')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_PO_LF50.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_PO_LF50.xlsx', engine = 'xlsxwriter')
...
ax5.set_title('Aggr. C-emissions/sequestration flow, PF_PO')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_PO_LF50.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_PO_LF50.xlsx', engine = 'xlsxwriter')
