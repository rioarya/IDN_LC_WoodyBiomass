...
#df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_S1')
df2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_S2')
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_E')
...
#S2
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_S2')
...
decomp_tot_S2 = df['C_remainAGB'].values




#S2_C
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_C_S2')
...
decomp_tot_S2_C = df['C_remainAGB'].values



#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_E')
...
#E_EC
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_C_E')
...
df2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_S2')
df2_C = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_C_S2')
dfE= pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_E')
dfE_C = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_C_E')
...
#S2
df2_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_S2')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_E')
...
#S2
df2_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_S2')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'RIL_E')
...
Emissions_S2 = [c_firewood_energy_S2, decomp_tot_S2, TestDSM2.o, PH_Emissions_HWP2, decomp_tot_CO2_S2[:,0]]
Emissions_E = [c_firewood_energy_E, c_pellets_E, decomp_tot_E, TestDSME.o, PH_Emissions_HWPE, decomp_tot_CO2_E[:,0]]
Emissions_S2_C = [c_firewood_energy_S2, decomp_tot_S2_C, TestDSM2.o, PH_Emissions_HWP2, decomp_tot_CO2_S2[:,0]]
...
writer = pd.ExcelWriter('emissions_seq_RIL_Rel.xlsx', engine = 'xlsxwriter')
...
#read S2
df = pd.read_excel('emissions_seq_RIL_Rel.xlsx', 'RIL_S2')
...
#read S2_C
df = pd.read_excel('emissions_seq_RIL_Rel.xlsx', 'RIL_C_S2')
...
#read E
df = pd.read_excel('emissions_seq_RIL_Rel.xlsx', 'RIL_E') # can also index sheet by name or fetch all sheets
...
#read E_C
df = pd.read_excel('emissions_seq_RIL_Rel.xlsx', 'RIL_C_E') # can also index sheet by name or fetch all sheets
...
#read S2
df = pd.read_excel('RIL_Rel.xlsx', 'NonRW_RIL_S2')
emission_NonRW_RIL_S2 = df['NonRW_emissions'].tolist()
emission_NonRW_RIL_S2_seq = df['kg_CO2_seq'].tolist()


#read E
df = pd.read_excel('RIL_Rel.xlsx', 'NonRW_RIL_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_RIL_Rel.xlsx', engine = 'xlsxwriter')
...
decomp_tot_S2 = [x/division for x in decomp_tot_S2]
...
#RIL_C_M
decomp_tot_S2_C = [x/division for x in decomp_tot_S2_C]
...
Column3 = decomp_tot_S2
Column3_C = decomp_tot_S2_C
Column4 = TestDSM2.o
...
writer = pd.ExcelWriter('C_flows_RIL_Rel.xlsx', engine = 'xlsxwriter')
...
ax1_s.plot(t, decomp_tot_S2, color='lightcoral', label='F1-0: Residue decomposition')
...
ax1.plot(t, decomp_tot_S2, color='lightcoral', label='F1-0: Residue decomposition')
...
#ax1_s.plot(t, OC_storage_RIL_S2, color='darkturquoise', label='9: Landfill storage') 
ax1_C_s.plot(t, decomp_tot_S2_C, color='lightcoral', label='F1-0: Residue decomposition')
...
#ax1.plot(t, OC_storage_RIL_S2, color='darkturquoise', label='9: Landfill storage') 
ax1_C.plot(t, decomp_tot_S2_C, color='lightcoral', label='F1-0: Residue decomposition')
...
ax2_s.plot(t, decomp_tot_E, color='lightcoral', label='F1-0: Residue decomposition')
...
#ax2_s.plot(t, OC_storage_RIL_E, color='darkturquoise', label='9: Landfill storage') 
ax2_C_s.plot(t, decomp_tot_E_C, color='lightcoral', label='F1-0: Residue decomposition')
...
Agg_Cflow_S2 = [c_firewood_energy_S2, RIL_seq_S2, decomp_tot_S2, TestDSM2.o, PH_Emissions_HWP2, Landfill_decomp_S2, flat_list_RIL]
Agg_Cflow_E = [c_firewood_energy_E, RIL_seq_E, c_pellets_E, decomp_tot_E, TestDSME.o, PH_Emissions_HWPE, decomp_tot_CO2_E[:,0], Landfill_decomp_E, flat_list_RIL]
Agg_Cflow_S2_C = [c_firewood_energy_S2, RIL_seq_C_S2, decomp_tot_S2_C, TestDSM2.o, PH_Emissions_HWP2, Landfill_decomp_S2, flat_list_RIL_C]
Agg_Cflow_E_C = [c_firewood_energy_E, RIL_seq_C_E, c_pellets_E, decomp_tot_E_C, TestDSME.o, PH_Emissions_HWPE, decomp_tot_CO2_E[:,0], Landfill_decomp_E, flat_list_RIL_C]
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_RIL_Rel.xlsx', engine = 'xlsxwriter')
...
plt.savefig('NCB RIL_Rel.png', dpi=300)
...
df2_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'NonRW_RIL_S2')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_Rel.xlsx', 'NonRW_RIL_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_RIL_Rel.xlsx', engine = 'xlsxwriter')
