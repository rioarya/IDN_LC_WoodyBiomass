...
df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_S1')
#df2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL.xlsx', 'RIL_S2')
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_E')
...
#S1
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_S1')
...
#S1_C
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_C_S1')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_E')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_C_E')
...
df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_S1')
df1_C = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_C_S1')
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_E')
dfE_C = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_C_E')
...
#S1
df1_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_S1')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_E')
...
#S1
df1_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_S1')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'RIL_E')
...
writer = pd.ExcelWriter('emissions_seq_RIL_EC_LF50.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S1
df = pd.read_excel('emissions_seq_RIL_EC_LF50.xlsx', 'RIL_S1') # can also index sheet by name or fetch all sheets
...
#read S2_C
df = pd.read_excel('emissions_seq_RIL_EC_LF50.xlsx', 'RIL_C_S1') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('emissions_seq_RIL_EC_LF50.xlsx', 'RIL_E') # can also index sheet by name or fetch all sheets
...
#read E_EC
df = pd.read_excel('emissions_seq_RIL_EC_LF50.xlsx', 'RIL_C_E') # can also index sheet by name or fetch all sheets
...
#read S1
df = pd.read_excel('RIL_EC_LF50.xlsx', 'NonRW_RIL_S1') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('RIL_EC_LF50.xlsx', 'NonRW_RIL_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_RIL_EC_LF50.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_RIL_EC_LF50.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_RIL_EC_LF50.xlsx', engine = 'xlsxwriter')
...
df1_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'NonRW_RIL_S1')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_LF50.xlsx', 'NonRW_RIL_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_RIL_EC_LF50.xlsx', engine = 'xlsxwriter')
