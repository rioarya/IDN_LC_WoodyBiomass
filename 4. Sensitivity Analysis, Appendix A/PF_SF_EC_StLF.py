...
df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_S1')
df3 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_E')
...
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_E')
...
#S1
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_S1')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_E')
...
writer = pd.ExcelWriter('OutDSM_PF_SF_EC_StLF.xlsx', engine = 'xlsxwriter')
...
#S1
df1_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_S1')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_E')
...
#S1
df1_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_S1')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'PF_SF_E')
...
writer = pd.ExcelWriter('emissions_seq_PF_SF_EC_StLF.xlsx', engine = 'xlsxwriter')
...
#wood-based
#read S1_moist
df = pd.read_excel('emissions_seq_PF_SF_EC_StLF.xlsx', 'S1_moist') # can also index sheet by name or fetch all sheets
...
#read S1_dry
df = pd.read_excel('emissions_seq_PF_SF_EC_StLF.xlsx', 'S1_dry')
...
#read E_moist
df = pd.read_excel('emissions_seq_PF_SF_EC_StLF.xlsx', 'E_moist') # can also index sheet by name or fetch all sheets
...
#read E_dry
df = pd.read_excel('emissions_seq_PF_SF_EC_StLF.xlsx', 'E_dry')
...
#read S1
df = pd.read_excel('PF_SF_EC_StLF.xlsx', 'NonRW_PF_SF_S1') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('PF_SF_EC_StLF.xlsx', 'NonRW_PF_SF_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_SF_EC_StLF.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_SF_EC_StLF.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_SF_EC_StLF.xlsx', engine = 'xlsxwriter')
...
df1_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'NonRW_PF_SF_S1')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_StLF.xlsx', 'NonRW_PF_SF_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_SF_EC_StLF.xlsx', engine = 'xlsxwriter')
