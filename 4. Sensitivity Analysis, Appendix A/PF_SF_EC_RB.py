...
writer = pd.ExcelWriter('emissions_seq_PF_SF_EC_RB.xlsx', engine = 'xlsxwriter')
...
#wood-based
#read S1_moist
df = pd.read_excel('emissions_seq_PF_SF_EC_RB.xlsx', 'S1_moist') # can also index sheet by name or fetch all sheets
...
#read S1_dry
df = pd.read_excel('emissions_seq_PF_SF_EC_RB.xlsx', 'S1_dry')
...
#read E_moist
df = pd.read_excel('emissions_seq_PF_SF_EC_RB.xlsx', 'E_moist') # can also index sheet by name or fetch all sheets
...
#read E_dry
df = pd.read_excel('emissions_seq_PF_SF_EC_RB.xlsx', 'E_dry')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_SF_EC_RB.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_SF_EC_RB.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_SF_EC_RB.xlsx', engine = 'xlsxwriter')
...
df1_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC.xlsx', 'NonRW_PF_SF_S1')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC.xlsx', 'NonRW_PF_SF_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_SF_EC_RB.xlsx', engine = 'xlsxwriter')
