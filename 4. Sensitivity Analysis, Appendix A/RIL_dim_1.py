...
#df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_S1')
df2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_S2')
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_E')
...
#S2
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_S2')
...
#S2_C
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_C_S2')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_E')
...
#E_C
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_C_E')
...
df2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_S2')
df2_C = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_C_S2')
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_E')
dfE_C = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_C_E')
...
#S2
df2_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_S2')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_E')
...
#S2
df2_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_S2')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'RIL_E')
...
writer = pd.ExcelWriter('emissions_seq_RIL_dim.xlsx', engine = 'xlsxwriter')
...
#read S2
df = pd.read_excel('emissions_seq_RIL_dim.xlsx', 'RIL_S2')
...
#read S2_C
df = pd.read_excel('emissions_seq_RIL_dim.xlsx', 'RIL_C_S2')
...
#read E
df = pd.read_excel('emissions_seq_RIL_dim.xlsx', 'RIL_E') # can also index sheet by name or fetch all sheets
...
#read E_C
df = pd.read_excel('emissions_seq_RIL_dim.xlsx', 'RIL_C_E') # can also index sheet by name or fetch all sheets
...
#read S2
df = pd.read_excel('RIL_dim.xlsx', 'NonRW_RIL_S2')
emission_NonRW_RIL_S2 = df['NonRW_emissions'].tolist()
emission_NonRW_RIL_S2_seq = df['kg_CO2_seq'].tolist()


#read E
df = pd.read_excel('RIL_dim.xlsx', 'NonRW_RIL_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_RIL_dim.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_RIL_dim.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_RIL_dim.xlsx', engine = 'xlsxwriter')
...
plt.savefig('NCB RIL_dim.png', dpi=300)
...
df2_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'NonRW_RIL_S2')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_dim.xlsx', 'NonRW_RIL_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_RIL_dim.xlsx', engine = 'xlsxwriter')
