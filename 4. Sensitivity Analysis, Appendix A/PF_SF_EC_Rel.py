...
df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_S1')
df3 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_E')
...
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_E')
...
#S1
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_S1')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_E')
...
#S1
df1_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_S1')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_E')
...
#S1
df1_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_S1')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'PF_SF_E')
...
Emissions_PF_SF_S1 = [c_firewood_energy_S1, decomp_tot_S1, TestDSM1.o, PH_Emissions_HWP1_S1, decomp_tot_CO2_S1[:,0]]
Emissions_PF_SF_E = [c_firewood_energy_E, c_pellets_E, decomp_tot_E, TestDSME.o, PH_Emissions_HWP1_E, decomp_tot_CO2_E[:,0]]
...
writer = pd.ExcelWriter('emissions_seq_PF_SF_EC_Rel.xlsx', engine = 'xlsxwriter')
...
#wood-based
#read S1_moist
df = pd.read_excel('emissions_seq_PF_SF_EC_Rel.xlsx', 'S1_moist') # can also index sheet by name or fetch all sheets
...
#read S1_dry
df = pd.read_excel('emissions_seq_PF_SF_EC_Rel.xlsx', 'S1_dry')
...
#read E_moist
df = pd.read_excel('emissions_seq_PF_SF_EC_Rel.xlsx', 'E_moist') # can also index sheet by name or fetch all sheets
...
#read E_dry
df = pd.read_excel('emissions_seq_PF_SF_EC_Rel.xlsx', 'E_dry')
...
#read S1
df = pd.read_excel('PF_SF_EC_Rel.xlsx', 'NonRW_PF_SF_S1') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('PF_SF_EC_Rel.xlsx', 'NonRW_PF_SF_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_SF_EC_Rel.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_SF_EC_Rel.xlsx', engine = 'xlsxwriter')
...
ax_a.plot(t, decomp_tot_S1, color='lightcoral', label='F1-0: Residue decomposition')
...
ax_b.plot(t, decomp_tot_S1, color='lightcoral')
...
ax_c.plot(t, decomp_tot_E, color='lightcoral', label='F1-0: Residue decomposition')
...
ax_d.plot(t, decomp_tot_E, color='lightcoral')
...
Agg_Cflow_PF_SF_S1moi = [c_firewood_energy_S1, decomp_tot_S1, TestDSM1.o, PH_Emissions_HWP1_S1, Landfill_decomp_S1, flat_list_moist]
Agg_Cflow_PF_SF_S1dry = [c_firewood_energy_S1, decomp_tot_S1, TestDSM1.o, PH_Emissions_HWP1_S1, Landfill_decomp_S1, flat_list_dry]
Agg_Cflow_PF_SF_Emoi = [c_firewood_energy_E, c_pellets_E, decomp_tot_E, TestDSME.o, PH_Emissions_HWP1_E, Landfill_decomp_E, flat_list_moist]
Agg_Cflow_PF_SF_Edry = [c_firewood_energy_E, c_pellets_E, decomp_tot_E, TestDSME.o, PH_Emissions_HWP1_E, Landfill_decomp_E, flat_list_dry]
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_SF_EC_Rel.xlsx', engine = 'xlsxwriter')
...
df1_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'NonRW_PF_SF_S1')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF_EC_Rel.xlsx', 'NonRW_PF_SF_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_SF_EC_Rel.xlsx', engine = 'xlsxwriter')
