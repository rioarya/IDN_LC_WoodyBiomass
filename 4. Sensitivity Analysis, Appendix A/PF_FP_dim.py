...
writer = pd.ExcelWriter('emissions_seq_PF_FP_dim.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_PF_FP_dim.xlsx', 'PF_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_PF_FP_dim.xlsx', 'PF_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_PF_FP_dim.xlsx', 'PF_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_PF_FP_dim.xlsx', 'PF_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_PF_FP_dim.xlsx', 'PF_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_7y
df = pd.read_excel('NonRW_PF_FP_dim.xlsx', 'PF_FP_S2_Ac_7y')
...
#read S2_Ac_18y
df = pd.read_excel('NonRW_PF_FP_dim.xlsx', 'PF_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('NonRW_PF_FP_dim.xlsx', 'PF_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
emissions_NonRW_S2_Tgr_40y = df['NonRW_emissions'].tolist()
emissions_NonRW_S2_Tgr_40y_seq = df['kg_CO2_seq'].tolist()


#read S2_Tgr_60y
df = pd.read_excel('NonRW_PF_FP_dim.xlsx', 'PF_FP_S2_Tgr_60y')
emissions_NonRW_S2_Tgr_60y = df['NonRW_emissions'].tolist()
emissions_NonRW_S2_Tgr_60y_seq = df['kg_CO2_seq'].tolist()


#read E2_Hbr_40y
df = pd.read_excel('NonRW_PF_FP_dim.xlsx', 'PF_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWI_inst_NonRW_PF_FP_dim', dpi=300)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWI_cum_PF_FP_dim', dpi=300)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig\GWP_dyn_cum_NonRW_PF_FP_dim', dpi=300)
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_FP_dim.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_FP_dim.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_FP_dim.xlsx', engine = 'xlsxwriter')
...
df2_amount_Ac7 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_PF_FP_dim.xlsx', 'PF_FP_S2_Ac_7y')
...
##NonRW materials/energy amount (F9-0-1)
df2_amount_Ac18 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_PF_FP_dim.xlsx', 'PF_FP_S2_Ac_18y')
...
##NonRW materials/energy amount (F9-0-1)
df2_amount_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_PF_FP_dim.xlsx', 'PF_FP_S2_Tgr_60y')
...
##NonRW materials/energy amount (F9-0-1)
dfE2_amount_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\NonRW_PF_FP_dim.xlsx', 'PF_FP_E2_Hbr_40y')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_FP_dim.xlsx', engine = 'xlsxwriter')
