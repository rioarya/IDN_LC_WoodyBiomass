...
writer = pd.ExcelWriter('emissions_seq_RIL_EC_RB.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S1
df = pd.read_excel('emissions_seq_RIL_EC_RB.xlsx', 'RIL_S1') # can also index sheet by name or fetch all sheets
...
#read S2_C
df = pd.read_excel('emissions_seq_RIL_EC_RB.xlsx', 'RIL_C_S1') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('emissions_seq_RIL_EC_RB.xlsx', 'RIL_E') # can also index sheet by name or fetch all sheets
...
#read E_EC
df = pd.read_excel('emissions_seq_RIL_EC_RB.xlsx', 'RIL_C_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_RIL_EC_RB.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_RIL_EC_RB.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_RIL_EC_RB.xlsx', engine = 'xlsxwriter')
...
df1_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC.xlsx', 'NonRW_RIL_S1')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC.xlsx', 'NonRW_RIL_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_RIL_EC_RB.xlsx', engine = 'xlsxwriter')
