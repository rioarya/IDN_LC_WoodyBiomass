...
df1_Ac7 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Ac_7y')
df1_Ac18 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Ac_18y')
df1_Tgr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Tgr_40y')
df1_Tgr60 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Tgr_60y')
dfE_Hbr40 = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_E_Hbr_40y')
...
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_E_Hbr_40y')
...
#Ac_7y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Ac_7y')
...
#S1_Ac_18y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Ac_18y')
...
#S1_Tgr_40y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Tgr_40y')
...
#S1_Tgr_60y
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Tgr_60y')
...
#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_E_Hbr_40y')
...
df1_Ac_7y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Ac_7y')
df1_Ac_18y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Ac_18y')
df1_Tgr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Tgr_40y')
dfl_Tgr_60y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_S1_Tgr_60y')
dfE_Hbr_40y = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_FP_Rel.xlsx', 'PF_FP_E_Hbr_40y')
...
writer = pd.ExcelWriter('emissions_seq_PF_FP_EC_Rel.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S1_Ac_7y
df = pd.read_excel('emissions_seq_PF_FP_EC_Rel.xlsx', 'PF_FP_S1_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S1_Ac_18y
df = pd.read_excel('emissions_seq_PF_FP_EC_Rel.xlsx', 'PF_FP_S1_Ac_18y')
...
#read S1_Tgr_40y
df = pd.read_excel('emissions_seq_PF_FP_EC_Rel.xlsx', 'PF_FP_S1_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S1_Tgr_60y
df = pd.read_excel('emissions_seq_PF_FP_EC_Rel.xlsx', 'PF_FP_S1_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_PF_FP_EC_Rel.xlsx', 'PF_FP_E_Hbr_40y') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_FP_EC_Rel.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_FP_EC_Rel.xlsx', engine = 'xlsxwriter')
...
ax_a.plot(t, decomp_tot_S1_Ac_7y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax_b.plot(t, decomp_tot_S1_Ac_7y, color='lightcoral')
...
ax_c.plot(t, decomp_tot_S1_Ac_18y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax_d.plot(t, decomp_tot_S1_Ac_18y, color='lightcoral')
...
ax_e.plot(t, decomp_tot_S1_Tgr_60y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax_f.plot(t, decomp_tot_S1_Tgr_60y, color='lightcoral')
...
ax_g.plot(t, decomp_tot_E_Hbr_40y, color='lightcoral', label='F1-0: Residue decomposition')
...
ax_h.plot(t, decomp_tot_E_Hbr_40y, color='lightcoral')
...
Agg_Cflow_S1_Ac_7y = [c_firewood_energy_S1_Ac7, decomp_tot_S1_Ac_7y, TestDSM1_Ac7.o, PH_Emissions_HWP1_Ac_7y, Landfill_decomp_PF_FP_S1_Ac_7y, flat_list_Ac_7y]
Agg_Cflow_S1_Ac_18y = [c_firewood_energy_S1_Ac18, decomp_tot_S1_Ac_18y, TestDSM1_Ac18.o, PH_Emissions_HWP1_Ac_18y, Landfill_decomp_PF_FP_S1_Ac_18y, flat_list_Ac_18y]
Agg_Cflow_S1_Tgr_60y = [c_firewood_energy_S1_Tgr60, decomp_tot_S1_Tgr_60y, TestDSM1_Tgr60.o, PH_Emissions_HWP1_Tgr_60y, Landfill_decomp_PF_FP_S1_Tgr_60y, flat_list_Tgr_60y]
Agg_Cflow_E_Hbr_40y = [c_firewood_energy_E_Hbr40, c_pellets_Hbr_40y, decomp_tot_E_Hbr_40y, TestDSME_Hbr40.o, PH_Emissions_HWPE_Hbr_40y, Landfill_decomp_PF_FP_E_Hbr_40y, flat_list_Hbr_40y]
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_FP_EC_Rel.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_FP_EC_Rel.xlsx', engine = 'xlsxwriter')
