...
writer = pd.ExcelWriter('emissions_seq_PF_PO_EC_RB.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S1_nucleus
df = pd.read_excel('emissions_seq_PF_PO_EC_RB.xlsx', 'S1_nucleus') # can also index sheet by name or fetch all sheets
...
#read S1_plasma
df = pd.read_excel('emissions_seq_PF_PO_EC_RB.xlsx', 'S1_plasma')
...
#read E_nucleus
df = pd.read_excel('emissions_seq_PF_PO_EC_RB.xlsx', 'E_nucleus') # can also index sheet by name or fetch all sheets
...
#read E_plasma
df = pd.read_excel('emissions_seq_PF_PO_EC_RB.xlsx', 'E_plasma')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_PO_EC_RB.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_PO_EC_RB.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_PO_EC_RB.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_PO_EC_RB.xlsx', engine = 'xlsxwriter')
