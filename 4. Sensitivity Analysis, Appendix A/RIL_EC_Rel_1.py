...
df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_S1')
#df2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL.xlsx', 'RIL_S2')
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_E')
...
#S1
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_S1')
...
decomp_tot_S1 = df['C_remainAGB'].values




#S1_C
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_C_S1')
...
decomp_tot_S1_C = df['C_remainAGB'].values



#E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_E')
...
decomp_tot_E = df['C_remainAGB'].values




#C_E
df = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_C_E')
...
decomp_tot_E_C = df['C_remainAGB'].values
...
plt.plot(t,decomp_tot_S1_C,label='S1_C')
...
df1 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_S1')
df1_C = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_C_S1')
dfE = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_E')
dfE_C = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_C_E')
...
#S1
df1_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_S1')
...
#E
dfE_CH4 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_E')
...
#S1
df1_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_S1')
...
#E
dfE_CO2 = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'RIL_E')
...
Emissions_S1 = [c_firewood_energy_S1, decomp_tot_S1, TestDSM1.o, PH_Emissions_HWP1, decomp_tot_CO2_S1[:,0]]
Emissions_E = [c_firewood_energy_E, c_pellets_E, decomp_tot_E, TestDSME.o, PH_Emissions_HWPE, decomp_tot_CO2_E[:,0]]
Emissions_S1_C = [c_firewood_energy_S1, decomp_tot_S1_C, TestDSM1.o, PH_Emissions_HWP1, decomp_tot_CO2_S1[:,0]]
Emissions_E_C = [c_firewood_energy_E, c_pellets_E, decomp_tot_E_C, TestDSME.o, PH_Emissions_HWPE, decomp_tot_CO2_E[:,0]]
...
writer = pd.ExcelWriter('emissions_seq_RIL_EC_Rel.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S1
df = pd.read_excel('emissions_seq_RIL_EC_Rel.xlsx', 'RIL_S1') # can also index sheet by name or fetch all sheets
...
#read S2_C
df = pd.read_excel('emissions_seq_RIL_EC_Rel.xlsx', 'RIL_C_S1') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('emissions_seq_RIL_EC_Rel.xlsx', 'RIL_E') # can also index sheet by name or fetch all sheets
...
#read E_EC
df = pd.read_excel('emissions_seq_RIL_EC_Rel.xlsx', 'RIL_C_E') # can also index sheet by name or fetch all sheets
...
#read S1
df = pd.read_excel('RIL_EC_Rel.xlsx', 'NonRW_RIL_S1') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('RIL_EC_Rel.xlsx', 'NonRW_RIL_E') # can also index sheet by name or fetch all sheets
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_RIL_EC_Rel.xlsx', engine = 'xlsxwriter')
...
decomp_tot_S1 = [x/division for x in decomp_tot_S1]
...
#RIL_C_M_existing
decomp_tot_S1_C = [x/division for x in decomp_tot_S1_C]
...
decomp_tot_E = [x/division for x in decomp_tot_E]
...
#RIL_C_E
decomp_tot_E_C = [x/division for x in decomp_tot_E_C]
...
Column9 = decomp_tot_E
Column9_C = decomp_tot_E_C
Column10 = TestDSME.o
...
Column14 = decomp_tot_S1
Column14_C = decomp_tot_S1_C
Column15 = TestDSM1.o
...
writer = pd.ExcelWriter('C_flows_RIL_EC_Rel.xlsx', engine = 'xlsxwriter')
...
ax1_s.plot(t, decomp_tot_S1, color='lightcoral', label='F1-0: Residue decomposition')
...
ax1.plot(t, decomp_tot_S1, color='lightcoral', label='F1-0: Residue decomposition')
...
#ax1_s.plot(t, OC_storage_RIL_S1, color='darkturquoise', label='9: Landfill storage') 
ax1_C_s.plot(t, decomp_tot_S1_C, color='lightcoral', label='F1-0: Residue decomposition')
...
#ax1.plot(t, OC_storage_RIL_S1, color='darkturquoise', label='9: Landfill storage') 
ax1_C.plot(t, decomp_tot_S1_C, color='lightcoral', label='F1-0: Residue decomposition')
...
ax2_s.plot(t, decomp_tot_E, color='lightcoral', label='1F1-0: Residue decomposition')
...
ax2.plot(t, decomp_tot_E, color='lightcoral', label='F1-0: Residue decomposition')
...
#ax2_s.plot(t, OC_storage_RIL_E, color='darkturquoise', label='9: Landfill storage') 
ax2_C_s.plot(t, decomp_tot_E_C, color='lightcoral', label='1F1-0: Residue decomposition')
...
#ax2.plot(t, OC_storage_RIL_E, color='darkturquoise', label='9: Landfill storage') 
ax2_C.plot(t, decomp_tot_E_C, color='lightcoral', label='F1-0: Residue decomposition')
...
Agg_Cflow_S1 = [c_firewood_energy_S1, RIL_seq_S1, decomp_tot_S1, TestDSM1.o, PH_Emissions_HWP1, Landfill_decomp_S1, flat_list_RIL]
Agg_Cflow_E = [c_firewood_energy_E, RIL_seq_E, c_pellets_E, decomp_tot_E, TestDSME.o, PH_Emissions_HWPE, Landfill_decomp_E, flat_list_RIL]
Agg_Cflow_S1_C = [c_firewood_energy_S1, RIL_seq_C_S1, decomp_tot_S1_C, TestDSM1.o, PH_Emissions_HWP1, Landfill_decomp_S1, flat_list_RIL_C]
Agg_Cflow_E_C = [c_firewood_energy_E, RIL_seq_C_E, c_pellets_E, decomp_tot_E_C, TestDSME.o, PH_Emissions_HWPE, Landfill_decomp_E, flat_list_RIL_C]
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_RIL_EC_Rel.xlsx', engine = 'xlsxwriter')
...
df1_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'NonRW_RIL_S1')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\RIL_EC_Rel.xlsx', 'NonRW_RIL_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_RIL_EC_Rel.xlsx', engine = 'xlsxwriter')
