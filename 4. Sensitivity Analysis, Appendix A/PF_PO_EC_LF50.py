...
df1nu = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_S1nu')
df1pl = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_S1pl')
df3nu = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_Enu')
df3pl = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_Epl')
...
dfEnu = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_Enu')
dfEpl = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_Epl')
...
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_S1nu')
...
#S1pl
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_S1pl')
...
#Enu
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_Enu')
...
#Epl
df = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_PO_EC_LF50.xlsx', 'PF_PO_Epl')
...
writer = pd.ExcelWriter('emissions_seq_PF_PO_EC_LF50.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S1_nucleus
df = pd.read_excel('emissions_seq_PF_PO_EC_LF50.xlsx', 'S1_nucleus') # can also index sheet by name or fetch all sheets
...
#read S1_plasma
df = pd.read_excel('emissions_seq_PF_PO_EC_LF50.xlsx', 'S1_plasma')
...
#read E_nucleus
df = pd.read_excel('emissions_seq_PF_PO_EC_LF50.xlsx', 'E_nucleus') # can also index sheet by name or fetch all sheets
...
#read E_plasma
df = pd.read_excel('emissions_seq_PF_PO_EC_LF50.xlsx', 'E_plasma')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_PO_EC_LF50.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_PO_EC_LF50.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_PO_EC_LF50.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_PO_EC_LF50.xlsx', engine = 'xlsxwriter')
