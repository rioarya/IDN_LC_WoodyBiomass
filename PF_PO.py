...
plt.title('Instantaneous GWI, PF_PO',fontsize=12)
...
plt.title('Cumulative GWI, PF_PO', fontsize=12)
...
ax.set_title('Dynamic GWP, PF_PO', fontsize=12)
...
ax5a.tick_params(axis='both', labelsize=12)
...
ax5b.tick_params(axis='both', labelsize=12)
...
ax5a.legend(bbox_to_anchor=(1.04,1), loc="upper left", prop={'size': 12}, frameon=False)
...
ax5b.set_xlabel('Time (year)', fontsize=12)
ax5b.set_ylabel('C flows (t-C/ha)', fontsize=12)
ax5a.set_ylabel('C flows (t-C/ha)', fontsize=12)

ax5a.set_title('Net carbon balance, PF_PO', fontsize=12)

plt.savefig('NCB PF_PO.png', dpi=300)
