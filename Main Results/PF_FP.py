...
writer = pd.ExcelWriter('emissions_seq_PF_FP_S2.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_PF_FP_S2.xlsx', 'PF_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_PF_FP_S2.xlsx', 'PF_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_PF_FP_S2.xlsx', 'PF_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_PF_FP_S2.xlsx', 'PF_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_PF_FP_S2.xlsx', 'PF_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
ax.plot(t, GWI_inst_tot_NonRW_S2_Ac_18y, color='forestgreen', label='NR_M_Ac_18y', ls='--', alpha=0.55)
#plt.plot(t, GWI_inst_tot_NonRW_S2_Tgr_40y, color='lightcoral', label='NR_M_Tgr_40y', ls='--', alpha=0.55)
ax.plot(t, GWI_inst_tot_NonRW_S2_Tgr_60y, color='deeppink', label='NR_M_Tgr_60y', ls='--', alpha=0.55)
ax.plot(t, GWI_inst_tot_NonRW_E2_Hbr_40y, color='cornflowerblue', label='NR_E_Hbr_40y', ls='--', alpha=0.55)


#plt.plot(t, GWI_inst_tot_S2_Ac_7y, color='olive', label='M_Ac_7y')
ax.plot(t, GWI_inst_tot_S2_Ac_18y, color='forestgreen', label='M_Ac_18y')
#plt.plot(t, GWI_inst_tot_S2_Tgr_40y, color='lightcoral', label='S2_Tgr_40y')
ax.plot(t, GWI_inst_tot_S2_Tgr_60y, color='deeppink', label='M_Tgr_60y')
ax.plot(t, GWI_inst_tot_E2_Hbr_40y, color='cornflowerblue', label='E_Hbr_40y')
...
major_yticks = np.arange(-0.6e-9, 1.51e-9, 0.3e-9)
major_xticks = np.arange(0,201,25)

ax.set_xticks(major_xticks)
ax.set_yticks(major_yticks)


ax.set_title('Instantaneous GWI, PF_FP', fontsize=14)

ax.set_xlabel('Time (year)', fontsize=14)
#plt.ylabel('GWI_inst (10$^{-12}$ W/m$^2$)')
ax.set_ylabel('GWI_inst (W/(m$^2$.ha.year))', fontsize=14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIinst_PF_FP.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.plot(t, GWI_cum_NonRW_S2_Ac_18y, color='forestgreen', label='NR_M_Ac_18y', ls='--', alpha=0.55)
#plt.plot(t, GWI_cum_NonRW_S2_Tgr_40y, color='lightcoral', label='NR_M_Tgr_40y', ls='--', alpha=0.55)
ax.plot(t, GWI_cum_NonRW_S2_Tgr_60y, color='deeppink', label='NR_M_Tgr_60y', ls='--', alpha=0.55)
ax.plot(t, GWI_cum_NonRW_E2_Hbr_40y, color='cornflowerblue', label='NR_E_Hbr_40y', ls='--', alpha=0.55)

#plt.plot(t, GWI_cum_S2_Ac_7y, color='olive', label='M_Ac_7y')
ax.plot(t, GWI_cum_S2_Ac_18y, color='forestgreen', label='M_Ac_18y')
#plt.plot(t, GWI_cum_S2_Tgr_40y, color='lightcoral', label='S2_Tgr_40y')
ax.plot(t, GWI_cum_S2_Tgr_60y, color='deeppink', label='M_Tgr_60y')
ax.plot(t, GWI_cum_E2_Hbr_40y, color='cornflowerblue', label='E_Hbr_40y')
...
ax.set_ylabel('GWI_cum (W/(m$^2$.ha))', fontsize=14)
...
major_yticks = np.arange(-0.5e-7,2.01e-7,0.5e-7)
major_xticks = np.arange(0,201,25)
...
ax.set_title('Cumulative GWI, PF_FP', fontsize=14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIcum_PF_FP.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.plot(t, GWP_dyn_cum_NonRW_E2_Hbr_40y, color='cornflowerblue', label='NR_E_Hbr_40y', ls='--', alpha=0.55)
...
ax.plot(t, GWP_dyn_cum_E2_Hbr_40y, color='cornflowerblue', label='E_Hbr_40y')
...
major_yticks = np.arange(-500,1501,250)
major_xticks = np.arange(0,201,25)
...
ax.set_xlabel('Time (year)', fontsize=14)
ax.set_ylabel('GWP$_{dyn}$ (t-CO$_2$-eq/ha)', fontsize=14)

ax.tick_params(axis='both', labelsize=14)

ax.set_title('Dynamic GWP, PF_FP', fontsize=14)


plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWPdyn_PF_FP.svg', dpi=1000,
            bbox_inches = 'tight')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_FP.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_FP.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_FP.xlsx', engine = 'xlsxwriter')
...
# plot
#ax5a.plot(t, Agg_Cflow_PF_FP_S2_Ac_7y, color='olive', label='M_Ac_7y') 
ax5a.plot(t, Agg_Cflow_PF_FP_S2_Ac_18y, color='forestgreen', label='M_Ac_18y') 
ax5a.plot(t, Agg_Cflow_PF_FP_S2_Tgr_60y, color='deeppink', label='M_Tgr_60y')
ax5a.plot(t, Agg_Cflow_PF_FP_E2_Hbr_40y, color='cornflowerblue', label='E_Hbr_40y')
...
#ax5b.plot(t, Agg_Cflow_PF_FP_S2_Ac_7y, color='olive')
ax5b.plot(t, Agg_Cflow_PF_FP_S2_Ac_18y, color='forestgreen')
ax5b.plot(t, Agg_Cflow_PF_FP_S2_Tgr_60y, color='deeppink')
ax5b.plot(t, Agg_Cflow_PF_FP_E2_Hbr_40y, color='cornflowerblue')
...
ax5a.legend(bbox_to_anchor=(0.99,1), loc="upper left", prop={'size': 14}, frameon=False)
...
ax5b.set_xlabel('Time (year)', fontsize=14)
ax5b.set_ylabel('C flows (t-C/ha)', fontsize=14)
ax5a.set_ylabel('C flows (t-C/ha)', fontsize=14)

ax5a.set_title('Net carbon balance, PF_FP', fontsize=14)

plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\_NCB_PF_FP.svg', dpi=1000,
            bbox_inches = 'tight')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_FP.xlsx', engine = 'xlsxwriter')
