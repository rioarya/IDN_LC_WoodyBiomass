This folder is dedicated to the Python script to run the improved harvesting conversion efficiency scenarios (results shown in the manuscript)
...
- The flow names in Excel files may not so intuitive. I invite the readers to check the Appendix 2b for a more tidy version of the 
