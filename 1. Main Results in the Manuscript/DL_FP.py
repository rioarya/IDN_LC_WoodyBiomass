...
writer = pd.ExcelWriter('emissions_seq_DL_FP_S2.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_Ac_7y
df = pd.read_excel('emissions_seq_DL_FP_S2.xlsx', 'DL_FP_S2_Ac_7y') # can also index sheet by name or fetch all sheets
...
#read S2_Ac_18y
df = pd.read_excel('emissions_seq_DL_FP_S2.xlsx', 'DL_FP_S2_Ac_18y')
...
#read S2_Tgr_40y
df = pd.read_excel('emissions_seq_DL_FP_S2.xlsx', 'DL_FP_S2_Tgr_40y') # can also index sheet by name or fetch all sheets
...
#read S2_Tgr_60y
df = pd.read_excel('emissions_seq_DL_FP_S2.xlsx', 'DL_FP_S2_Tgr_60y')
...
#read E_Hbr_40y
df = pd.read_excel('emissions_seq_DL_FP_S2.xlsx', 'DL_FP_E2_Hbr_40y') # can also index sheet by name or fetch all sheets
...
ax.set_title('Instantaneous GWI, DL_FP', fontsize=14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIinst_DL_FP.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.set_title('Cumulative GWI, DL_FP', fontsize=14)

ax.tick_params(axis='both', labelsize=14)

plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIcum_DL_FP.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.set_title('Dynamic GWP, DL_FP', fontsize=14)


plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWPdyn_DL_FP.svg', dpi=1000,
            bbox_inches = 'tight')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_DL_FP.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_DL_FP.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_DL_FP.xlsx', engine = 'xlsxwriter')
...
#ax5.plot(t, Agg_Cflow_DL_FP_S2_Ac_7y, color='olive', label='M_Ac_7y') 
ax5.plot(t, Agg_Cflow_DL_FP_S2_Ac_18y, color='forestgreen', label='M_Ac_18y') 
ax5.plot(t, Agg_Cflow_DL_FP_S2_Tgr_60y, color='deeppink', label='M_Tgr_60y')
ax5.plot(t, Agg_Cflow_DL_FP_E2_Hbr_40y, color='cornflowerblue', label='E_Hbr_40y')  
...
ax5.set_ylabel('C flows (t-C/ha)', fontsize=14)

ax5.set_title('Net carbon balance, DL_FP', fontsize=14)


plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\_NCB_DL_FP.svg', dpi=1000,
            bbox_inches = 'tight')
...
writer = pd.ExcelWriter('C_flows_SysDef_DL_FP.xlsx', engine = 'xlsxwriter')
