...
writer = pd.ExcelWriter('emissions_seq_PF_SF.xlsx', engine = 'xlsxwriter')
...
#wood-based 
#read S2_moist
df = pd.read_excel('emissions_seq_PF_SF.xlsx', 'S2_moist') # can also index sheet by name or fetch all sheets
...
#read S2_dry
df = pd.read_excel('emissions_seq_PF_SF.xlsx', 'S2_dry')
...
#read E_moist
df = pd.read_excel('emissions_seq_PF_SF.xlsx', 'E_moist') # can also index sheet by name or fetch all sheets
...
#read E_dry
df = pd.read_excel('emissions_seq_PF_SF.xlsx', 'E_dry')
...
#read S2
df = pd.read_excel('PF_SF.xlsx', 'NonRW_PF_SF_S2') # can also index sheet by name or fetch all sheets
...
#read E
df = pd.read_excel('PF_SF.xlsx', 'NonRW_PF_SF_E') # can also index sheet by name or fetch all sheets
...
ax.plot(t, GWI_inst_tot_S2, color='deeppink', label='NR_M', ls='--')
ax.plot(t, GWI_inst_tot_E, color='cornflowerblue', label='NR_E', ls='--')


ax.plot(t, np.mean(np.array([GWI_inst_tot_S2moi, GWI_inst_tot_S2dry]), axis=0), color='deeppink', label='M')
#plt.plot(t, GWI_inst_tot_S2dry, color='deeppink', label='M_dry')
ax.plot(t, np.mean(np.array([GWI_inst_tot_Emoi, GWI_inst_tot_Edry]), axis=0), color='cornflowerblue', label='E')
...
ax.set_title('Instantaneous GWI, PF_SF', fontsize = 14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIinst_PF_SF.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.plot(t, GWI_cum_S2, color='deeppink', label='NR_M', ls='--')
ax.plot(t, GWI_cum_E, color='cornflowerblue', label='NR_E', ls='--')


#plt.plot(t, GWI_cum_S1moi, color='mediumseagreen', label='M_EC_moist')
#plt.plot(t, GWI_cum_S1dry, color='forestgreen', label='M_EC_dry')
ax.plot(t, np.mean(np.array([GWI_cum_S2moi, GWI_cum_S2dry]), axis=0), color='deeppink', label='M')
#plt.plot(t, GWI_cum_S2dry, color='deeppink', label='M_dry')
ax.plot(t, np.mean(np.array([GWI_cum_Emoi, GWI_cum_Edry]), axis=0), color='cornflowerblue', label='E')
...
ax.set_xlabel('Time (year)', fontsize = 14)
#plt.ylabel('GWI_cum (10$^{-11}$ W/m$^2$)', fontsize = 12)
ax.set_ylabel('GWI_cum (W/(m$^2$.ha))', fontsize = 14)


ax.set_xlim(0,200)
ax.set_ylim(-0.5e-7,1.5e-7)
...
ax.set_title('Cumulative GWI, PF_SF', fontsize = 14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIcum_PF_SF.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.plot(t, GWP_dyn_cum_NonRW_E, color='cornflowerblue', ls='--', label='NR_E')


ax.plot(t, [(g + h) / 2 for g, h in zip(GWP_dyn_cum_S2moi, GWP_dyn_cum_S2dry)], color='deeppink', label='M')
#ax.plot(t, GWP_dyn_cum_S2dry, color='deeppink', label='M_dry')
ax.plot(t, [(g + h) / 2 for g, h in zip(GWP_dyn_cum_Emoi, GWP_dyn_cum_Edry)], color='cornflowerblue', label='E')
...
ax.set_title('Dynamic GWP, PF_SF', fontsize=14)


plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWPdyn_PF_SF.svg', dpi=1000,
            bbox_inches = 'tight')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_SF.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_SF.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_SF.xlsx', engine = 'xlsxwriter')
...
# plot
ax3a.plot(t, [(g + h) / 2 for g, h in zip(Agg_Cflow_PF_SF_S2moi, Agg_Cflow_PF_SF_S2dry)], color='deeppink', label='M') 
#ax3a.plot(t, Agg_Cflow_PF_SF_S2dry, color='deeppink', label='M_dry') 
ax3a.plot(t, [(g + h) / 2 for g, h in zip(Agg_Cflow_PF_SF_Emoi, Agg_Cflow_PF_SF_Edry)], color='cornflowerblue', label='E') 
...
ax3b.plot(t, [(g + h) / 2 for g, h in zip(Agg_Cflow_PF_SF_S2moi, Agg_Cflow_PF_SF_S2dry)], color='deeppink') 
#ax3b.plot(t, Agg_Cflow_PF_SF_S2dry, color='deeppink') 
ax3b.plot(t, [(g + h) / 2 for g, h in zip(Agg_Cflow_PF_SF_Emoi, Agg_Cflow_PF_SF_Edry)], color='cornflowerblue') 
...
#ax3a.legend(bbox_to_anchor=(1.04,1), loc="upper left", frameon=False, prop={'size': 12})
ax3a.legend(bbox_to_anchor=(0.99,1), loc="upper left", frameon=False, prop={'size': 14})
...
ax3b.set_xlabel('Time (year)', fontsize = 14)
ax3b.set_ylabel('C flows (t-C/ha)', fontsize = 14)
ax3a.set_ylabel('C flows (t-C/ha)', fontsize = 14)

ax3a.set_title('Net carbon balance, PF_SF', fontsize = 14)

plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\_NCB PF_SF.svg', dpi=1000,
            bbox_inches = 'tight')
...
df2_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF.xlsx', 'NonRW_PF_SF_S2')
...
##NonRW materials/energy amount (F9-0-1)
dfE_amount = pd.read_excel('C:\\Work\\Programming\\Practice\\PF_SF.xlsx', 'NonRW_PF_SF_E')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_SF.xlsx', engine = 'xlsxwriter')
