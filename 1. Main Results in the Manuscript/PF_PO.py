...
writer = pd.ExcelWriter('emissions_seq_PF_PO.xlsx', engine = 'xlsxwriter')
...
##wood-based
#read S2_nucleus
df = pd.read_excel('emissions_seq_PF_PO.xlsx', 'S2_nucleus') # can also index sheet by name or fetch all sheets
...
#read S2_plasma
df = pd.read_excel('emissions_seq_PF_PO.xlsx', 'S2_plasma')
...
#read E_nucleus
df = pd.read_excel('emissions_seq_PF_PO.xlsx', 'E_nucleus') # can also index sheet by name or fetch all sheets
...
#read E_plasma
df = pd.read_excel('emissions_seq_PF_PO.xlsx', 'E_plasma')
...
ax.plot(t, np.mean(np.array([GWI_inst_tot_NonRW_S2nu, GWI_inst_tot_NonRW_S2pl]), axis=0), color='deeppink', label='NR_M', ls='--')
#plt.plot(t, GWI_inst_tot_NonRW_S2pl, color='lightcoral', label='NR_M_plasma', ls='--')
ax.plot(t, np.mean(np.array([GWI_inst_tot_NonRW_Enu, GWI_inst_tot_NonRW_Epl]), axis=0), color='cornflowerblue', label='NR_E', ls='--')
#plt.plot(t, GWI_inst_tot_NonRW_Epl, color='royalblue', label='NR_E_plasma', ls='--')

ax.plot(t, np.mean(np.array([GWI_inst_tot_S2nu, GWI_inst_tot_S2pl]), axis=0), color='deeppink', label='M')
#plt.plot(t, GWI_inst_tot_S2pl, color='lightcoral', label='M_plasma')
ax.plot(t, np.mean(np.array([GWI_inst_tot_Enu, GWI_inst_tot_Epl]), axis=0), color='cornflowerblue', label='E')
#plt.plot(t, GWI_inst_tot_Epl, color='royalblue', label='E_plasma')
...
ax.set_title('Instantaneous GWI, PF_PO',fontsize=14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIinst_PF_PO.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.plot(t, np.mean(np.array([GWI_cum_NonRW_S2nu, GWI_cum_NonRW_S2pl]), axis=0), color='deeppink', label='NR_M', ls='--')
#plt.plot(t, GWI_cum_NonRW_S2pl, color='lightcoral', label='NR_M_plasma', ls='--')
ax.plot(t, np.mean(np.array([GWI_cum_NonRW_Enu, GWI_cum_NonRW_Epl]), axis=0), color='cornflowerblue', label='NR_E', ls='--')
#plt.plot(t, GWI_cum_NonRW_Epl, color='royalblue', label='NR_E_plasma', ls='--')


ax.plot(t, np.mean(np.array([GWI_cum_S2nu, GWI_cum_S2pl]), axis=0), color='deeppink', label='M')
#plt.plot(t, GWI_cum_S2pl, color='lightcoral', label='M_plasma')
ax.plot(t, np.mean(np.array([GWI_cum_Enu, GWI_cum_Epl]), axis=0), color='cornflowerblue', label='E')
#plt.plot(t, GWI_cum_Epl, color='royalblue', label='E_plasma')
...
ax.set_title('Cumulative GWI, PF_PO', fontsize=14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIcum_PF_PO.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.plot(t, [(g + h) / 2 for g, h in zip(GWP_dyn_cum_NonRW_S2nu, GWP_dyn_cum_NonRW_S2pl)], color='deeppink', label='NR_M', ls='--')
#ax.plot(t, GWP_dyn_cum_NonRW_S2pl, color='lightcoral', label='NR_M_plasma', ls='--')
ax.plot(t, [(g + h) / 2 for g, h in zip(GWP_dyn_cum_NonRW_Enu, GWP_dyn_cum_NonRW_Epl)], color='cornflowerblue', label='NR_E', ls='--')
#ax.plot(t, GWP_dyn_cum_NonRW_Epl, color='royalblue', label='NR_E_plasma', ls='--')


ax.plot(t, [(g + h) / 2 for g, h in zip(GWP_dyn_cum_S2nu, GWP_dyn_cum_S2pl)], color='deeppink', label='M')
#ax.plot(t, GWP_dyn_cum_S2pl, color='lightcoral', label='M_plasma')
ax.plot(t, [(g + h) / 2 for g, h in zip(GWP_dyn_cum_Enu, GWP_dyn_cum_Epl)], color='cornflowerblue', label='E')
#ax.plot(t, GWP_dyn_cum_Epl, color='royalblue', label='E_plasma')
...
ax.set_title('Dynamic GWP, PF_PO', fontsize=14)


plt.draw()

plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWPdyn_PF_PO.svg', dpi=1000,
            bbox_inches = 'tight')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_PF_PO.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_PF_PO.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_PF_PO.xlsx', engine = 'xlsxwriter')
...
ax5a.plot(t, [(g + h) / 2 for g, h in zip(Agg_Cflow_PF_PO_S2nu, Agg_Cflow_PF_PO_S2pl)], color='deeppink', label='M') 
#ax5a.plot(t, Agg_Cflow_PF_PO_S2pl, color='darkturquoise', label='M_plasma') 
ax5a.plot(t, [(g + h) / 2 for g, h in zip(Agg_Cflow_PF_PO_Enu, Agg_Cflow_PF_PO_Epl)], color='cornflowerblue', label='E')
...
ax5b.plot(t, [(g + h) / 2 for g, h in zip(Agg_Cflow_PF_PO_S2nu, Agg_Cflow_PF_PO_S2pl)], color='deeppink') 
#ax5b.plot(t, Agg_Cflow_PF_PO_S2pl, color='darkturquoise') 
ax5b.plot(t, [(g + h) / 2 for g, h in zip(Agg_Cflow_PF_PO_Enu, Agg_Cflow_PF_PO_Epl)], color='cornflowerblue')
...
ax5a.set_title('Net carbon balance, PF_PO', fontsize=14)

plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\_NCB PF_PO.svg', dpi=1000,
            bbox_inches = 'tight')
...
writer = pd.ExcelWriter('C_flows_SysDef_PF_PO.xlsx', engine = 'xlsxwriter')
