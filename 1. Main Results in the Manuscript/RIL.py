...
writer = pd.ExcelWriter('emissions_seq_RIL.xlsx', engine = 'xlsxwriter')
...
#read S2
df = pd.read_excel('emissions_seq_RIL.xlsx', 'RIL_S2')
...
#read S2_C
df = pd.read_excel('emissions_seq_RIL.xlsx', 'RIL_C_S2')
...
#read E
df = pd.read_excel('emissions_seq_RIL.xlsx', 'RIL_E') # can also index sheet by name or fetch all sheets
...
#read E_C
df = pd.read_excel('emissions_seq_RIL.xlsx', 'RIL_C_E') # can also index sheet by name or fetch all sheets
...
ax.plot(t, GWI_inst_tot_NonRW_RIL_S2, color='forestgreen', label='NR_RIL_M', ls='--', alpha=0.55)
ax.plot(t, GWI_inst_tot_NonRW_RIL_E, color='lightcoral', label='NR_RIL_E', ls='--', alpha=0.55)



ax.plot(t, GWI_inst_tot_S2, color='forestgreen', label='RIL_M')
ax.plot(t, GWI_inst_tot_E, color='lightcoral', label='RIL_E')
ax.plot(t, GWI_inst_tot_S2_C, color='turquoise', label='RIL_C_M')
ax.plot(t, GWI_inst_tot_E_C, color='cornflowerblue', label='RIL_C_E')
...
ax.set_xlim(0,200)
ax.set_ylim(-1e-9,0.2e-9)

major_yticks = np.arange(-1e-9,0.21e-9,0.2e-9)
...
ax.set_title('Instantaneous GWI, RIL',fontsize=14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIinst_RIL.svg', dpi=1000,
            bbox_inches = 'tight')
...
ax.plot(t, GWI_cum_NonRW_RIL_S2, color='forestgreen', label='NR_RIL_M', ls='--', alpha=0.55)
ax.plot(t, GWI_cum_NonRW_RIL_E, color='lightcoral', label='NR_RIL_E', ls='--', alpha=0.55)


ax.plot(t, GWI_cum_S2, color='forestgreen', label='RIL_M')
ax.plot(t, GWI_cum_E, color='lightcoral', label='RIL_E')
ax.plot(t, GWI_cum_S2_C, color='turquoise', label='RIL_C_M')
ax.plot(t, GWI_cum_E_C, color='cornflowerblue', label='RIL_C_E')
...
ax.set_xlim(0,200)
ax.set_ylim(-1.2e-7,0.1e-7)

major_yticks = np.arange(-1.2e-7,0.11e-7,0.3e-7)
major_xticks = np.arange(0,201,25)

ax.set_xticks(major_xticks)
ax.set_yticks(major_yticks)

ax.set_title('Cumulative GWI, RIL',fontsize=14)
...
plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWIcum_RIL.svg', dpi=1000,
            bbox_inches = 'tight')
...
major_yticks = np.arange(-800, 101, 200)
major_xticks = np.arange(0,201,25)
...
ax.set_title('Dynamic GWP, RIL', fontsize=14)


plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\GWPdyn_RIL.svg', dpi=1000,
            bbox_inches = 'tight')
...
#Export to excel
writer = pd.ExcelWriter('GraphResults_RIL.xlsx', engine = 'xlsxwriter')
...
writer = pd.ExcelWriter('C_flows_RIL.xlsx', engine = 'xlsxwriter')
...
#Export to excel
writer = pd.ExcelWriter('AggCFlow_RIL.xlsx', engine = 'xlsxwriter')
...
ax3.legend(bbox_to_anchor=(0.99,1), loc="upper left", prop={'size': 14}, frameon=False)
...
ax3.set_ylabel('C flows (t-C/ha)', fontsize=14)

ax3.set_title('Net carbon balance, RIL', fontsize=14)

plt.savefig('C:\Work\Data\ID Future Scenarios\Hectare-based\Fig_Manuscript\_NCB_RIL.svg', dpi=1000,
            bbox_inches = 'tight')
...
writer = pd.ExcelWriter('C_flows_SysDef_RIL.xlsx', engine = 'xlsxwriter')
